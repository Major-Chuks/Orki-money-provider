...
type Asset = {
  ...
  fiat_icon_identifier: string;
  crypto_icon_identifier: string;
  fiat_icon: string;
  crypto_icon: string;
  network: string;
};
...
export const allProviders: ProvidersResponse = [
  {
    provider: {
      name: "Moonpay",
      identifier: "moonpay",
      icon: "https://moonpay.io/assets/images/logo.svg",
    },
    amount_to_receive: 0.003,
    exchange_rate: 100080.8,
    payment_methods: [
      {
    ...
    asset: {
      min_buy_amount: 30,
      max_buy_amount: 12000,
      fiat_icon_identifier: "usd",
      crypto_icon_identifier: "btc",
      fiat_icon: "https://static.moonpay.com/widget/currencies/usd.svg",
      crypto_icon: "https://static.moonpay.com/widget/currencies/btc.svg",
      network: "bitcoin",
    },
    link: "https://buy-sandbox.moonpay.com/?apiKey=pk_test_M2CfpAumdciX8FKGUbDx7nlsHrtRihp8&baseCurrencyCode=usd&baseCurrencyAmount=300",
    quote_amount: 0.003,
  },
  {
    provider: {
      name: "Transak",
      identifier: "transak",
      icon: "https://assets.transak.com/images/website/transak-logo.svg",
    },
    amount_to_receive: 0.00271591,
    exchange_rate: 96749,
    payment_methods: [
      {
        id: "credit_debit_card",
    ...
    link: "https://global-stg.transak.com?apiKey=20d3fbfb-60ed-4775-9b21-3bed7fa4b5c3&fiatCurrency=USD&cryptoCurrency=BTC&network=mainnet&productsAvailed=BUY&paymentMethod=credit_debit_card&fiatAmount=300",
    quote_amount: 0.00271591,
  },
];
...
export function prioritizeBestQuote(quotes: ProvidersResponse) {
  ...
  if (bestIndex > 0) {
    const [bestQuote] = quotes.splice(bestIndex, 1);
    quotes.unshift(bestQuote);
  }

  return quotes;
}

export const transakFiatCurrenciesResponse = [
  {
    code: "XCD",
...
export const transakCryptoCurrenciesResponse = [
  {
    code: "1INCH",
    name: "1inch",
    icon: "https://assets-stg.transak.com/images/cryptoCurrency/1inch_small.png",
    network: "ethereum",
    decimals: 18,
    min_amount: null,
    max_amount: null,
  ...
  },
  {
    code: "APE",
    name: "APE",
    icon: "https://assets-stg.transak.com/images/cryptoCurrency/apecoin_small.png",
    network: "ethereum",
    decimals: 18,
    min_amount: null,
    max_amount: null,
  ...
  },
  {
    code: "AVA",
    name: "AVA",
    icon: "https://assets-stg.transak.com/images/cryptoCurrency/concierge-io_small.png",
    network: "polygon",
    decimals: 18,
    min_amount: null,
    max_amount: null,
  ...
  },
  {
    code: "AAVE",
    name: "Aave",
    icon: "https://assets-stg.transak.com/images/cryptoCurrency/aave_small.png",
    network: "polygon",
    decimals: 18,
    min_amount: null,
    max_amount: null,
  ...
  },
  {
    code: "ADAI",
    name: "Aave DAI",
    icon: "https://assets-stg.transak.com/images/cryptoCurrency/aave-dai_small.png",
    network: "polygon",
    decimals: 18,
    min_amount: null,
    max_amount: null,
  ...
  },
  {
    code: "ADS",
    name: "Adshares",
    icon: "https://assets-stg.transak.com/images/cryptoCurrency/adshares_small.png",
    network: "ethereum",
    decimals: 18,
    min_amount: null,
    max_amount: null,
  ...
  },
  {
    code: "AZERO",
    name: "Aleph Zero",
    icon: "https://assets-stg.transak.com/images/cryptoCurrency/aleph-zero_small.png",
    network: "alephzero",
    decimals: 12,
    min_amount: null,
    max_amount: null,
  ...
  },
  {
    code: "ALGO",
    name: "Algorand",
    icon: "https://assets-stg.transak.com/images/cryptoCurrency/algorand_small.png",
    network: "mainnet",
    decimals: 6,
    min_amount: null,
    max_amount: null,
  ...
  },
  {
    ...
    icon: "https://assets-stg.transak.com/images/cryptoCurrency/alongside-crypto-market-index_small.png",
    network: "ethereum",
    decimals: 18,
    min_amount: null,
    max_amount: null,
  ...
  },
  {
    code: "APT",
    name: "Aptos",
    icon: "https://assets-stg.transak.com/images/cryptoCurrency/aptos_small.png",
    network: "aptos",
    decimals: 18,
    min_amount: null,
    max_amount: null,
  ...
  },
  {
    code: "ARKM",
    name: "Arkham",
    icon: "https://assets-stg.transak.com/images/cryptoCurrency/arkham_small.png",
    network: "ethereum",
    decimals: 18,
    min_amount: null,
    max_amount: null,
  ...
  },
  {
    code: "AR",
    name: "Arweave",
    icon: "https://assets-stg.transak.com/images/cryptoCurrency/arweave_small.png",
    network: "mainnet",
    decimals: 12,
    min_amount: null,
    max_amount: null,
  ...
  },
  {
    code: "ASTR",
    name: "Astar",
    icon: "https://assets-stg.transak.com/images/cryptoCurrency/astar_small.png",
    network: "astar",
    decimals: 18,
    min_amount: null,
    max_amount: null,
  ...
  },
  {
    code: "AUDIO",
    name: "Audius",
    icon: "https://assets-stg.transak.com/images/cryptoCurrency/audius_small.png",
    network: "ethereum",
    decimals: 18,
    min_amount: null,
    max_amount: null,
  ...
  },
  {
    code: "AURORA",
    name: "Aurora",
    icon: "https://assets-stg.transak.com/images/cryptoCurrency/aurora-near_small.png",
    network: "aurora",
    decimals: null,
    min_amount: null,
    max_amount: null,
  ...
  },
  {
    code: "AVAX",
    name: "Avalanche",
    icon: "https://assets-stg.transak.com/images/cryptoCurrency/avalanche-2_small.png",
    network: "mainnet",
    decimals: 9,
    min_amount: null,
    max_amount: null,
  ...
  },
  {
    code: "AXS",
    name: "Axie Infinity",
    icon: "https://assets-stg.transak.com/images/cryptoCurrency/axie-infinity_small.png",
    network: "mainnet",
    decimals: null,
    min_amount: null,
    max_amount: null,
  ...
  },
  {
    code: "BHAT",
    name: "BHNetwork",
    icon: "https://assets-stg.transak.com/images/cryptoCurrency/bhnetwork_small.png",
    network: "multiversx",
    decimals: 18,
    min_amount: null,
    max_amount: null,
  ...
  },
  {
    ...
    icon: "https://assets-stg.transak.com/images/cryptoCurrency/basic-attention-token_small.png",
    network: "ethereum",
    decimals: 18,
    min_amount: null,
    max_amount: null,
  ...
  },
  {
    code: "BEAM",
    name: "Beam",
    icon: "https://assets-stg.transak.com/images/cryptoCurrency/beam-2_small.png",
    network: "beam",
    decimals: 18,
    min_amount: null,
    max_amount: null,
  ...
  },
  {
    code: "BIFI",
    name: "Beefy.Finance",
    icon: "https://assets-stg.transak.com/images/cryptoCurrency/beefy-finance_small.png",
    network: "bsc",
    decimals: 18,
    min_amount: null,
    max_amount: null,
  ...
  },
  {
    code: "BNB",
    name: "Binance Coin",
    icon: "https://assets-stg.transak.com/images/cryptoCurrency/binancecoin_small.png",
    network: "bsc",
    decimals: 18,
    min_amount: null,
    max_amount: null,
  ...
  },
  {
    ...
    icon: "https://assets-stg.transak.com/images/cryptoCurrency/binance-peg-dogecoin_small.png",
    network: "mainnet",
    decimals: 8,
    min_amount: null,
    max_amount: null,
  ...
  },
  {
    code: "BCH",
    name: "Bitcoin Cash",
    icon: "https://assets-stg.transak.com/images/cryptoCurrency/binance-peg-bitcoin-cash_small.png",
    network: "mainnet",
    decimals: 8,
    min_amount: null,
    max_amount: null,
  ...
  },
  {
    code: "BSV",
    name: "Bitcoin SV",
    icon: "https://assets-stg.transak.com/images/cryptoCurrency/bitcoin-cash-sv_small.png",
    network: "bsv",
    decimals: 8,
    min_amount: null,
    max_amount: null,
  ...
  },
  {
    code: "BOLT",
    name: "Bolt",
    icon: "https://assets-stg.transak.com/images/cryptoCurrency/bolt_small.png",
    network: "ethereum",
    decimals: 18,
    min_amount: null,
    max_amount: null,
  ...
  },
  {
    code: "ADA",
    name: "Cardano",
    icon: "https://assets-stg.transak.com/images/cryptoCurrency/binance-peg-cardano_small.png",
    network: "mainnet",
    decimals: 6,
    min_amount: null,
    max_amount: null,
  ...
  },
  {
    code: "CTSI",
    name: "Cartesi",
    icon: "https://assets-stg.transak.com/images/cryptoCurrency/cartesi_small.png",
    network: "ethereum",
    decimals: 18,
    min_amount: null,
    max_amount: null,
  ...
  },
  {
    code: "CELO",
    name: "Celo",
    icon: "https://assets-stg.transak.com/images/cryptoCurrency/celo-gold_small.png",
    network: "celo",
    decimals: 18,
    min_amount: null,
    max_amount: null,
  ...
  },
  {
    code: "CUSD",
    name: "Celo Dollar",
    icon: "https://assets-stg.transak.com/images/cryptoCurrency/celo-dollar_small.png",
    network: "celo",
    decimals: 18,
    min_amount: null,
    max_amount: null,
  ...
  },
  {
    code: "CEUR",
    name: "Celo Euro",
    icon: "https://assets-stg.transak.com/images/cryptoCurrency/celo-euro_small.png",
    network: "celo",
    decimals: 18,
    min_amount: null,
    max_amount: null,
  ...
  },
  {
    code: "CHAIN",
    name: "Chain Games",
    icon: "https://assets-stg.transak.com/images/cryptoCurrency/chain-games_small.png",
    network: "polygon",
    decimals: 18,
    min_amount: null,
    max_amount: null,
  ...
  },
  {
    code: "LINK",
    name: "Chainlink",
    icon: "https://assets-stg.transak.com/images/cryptoCurrency/chainlink_small.png",
    network: "ethereum",
    decimals: 18,
    min_amount: null,
    max_amount: null,
  ...
  },
  {
    code: "CHZ",
    name: "Chiliz",
    icon: "https://assets-stg.transak.com/images/cryptoCurrency/chiliz_small.png",
    network: "chiliz",
    decimals: 18,
    min_amount: null,
    max_amount: null,
  ...
  },
  {
    code: "CHR",
    name: "Chromia",
    icon: "https://assets-stg.transak.com/images/cryptoCurrency/chromaway_small.png",
    network: "chromia",
    decimals: 6,
    min_amount: null,
    max_amount: null,
  ...
  },
  {
    code: "CLV",
    name: "Clover Finance",
    icon: "https://assets-stg.transak.com/images/cryptoCurrency/clover-finance_small.png",
    network: "ethereum",
    decimals: 18,
    min_amount: null,
    max_amount: null,
  ...
  },
  {
    code: "COMP",
    name: "Compound",
    icon: "https://assets-stg.transak.com/images/cryptoCurrency/compound-governance-token_small.png",
    network: "ethereum",
    decimals: 18,
    min_amount: null,
    max_amount: null,
  ...
  },
  {
    code: "ATOM",
    name: "Cosmos Hub",
    icon: "https://assets-stg.transak.com/images/cryptoCurrency/cosmos_small.png",
    network: "mainnet",
    decimals: 6,
    min_amount: null,
    max_amount: null,
  ...
  },
  {
    code: "CRO",
    name: "Cronos",
    icon: "https://assets-stg.transak.com/images/cryptoCurrency/crypto-com-chain_small.jpg",
    network: "cronos",
    decimals: 18,
    min_amount: null,
    max_amount: null,
  ...
  },
  {
    code: "DAO",
    name: "DAO Maker",
    icon: "https://assets-stg.transak.com/images/cryptoCurrency/dao-maker_small.png",
    network: "ethereum",
    decimals: 18,
    min_amount: null,
    max_amount: null,
  ...
  },
  {
    code: "DAI",
    name: "Dai",
    icon: "https://assets-stg.transak.com/images/cryptoCurrency/dai_small.png",
    network: "polygon",
    decimals: 18,
    min_amount: null,
    max_amount: null,
  ...
  },
  {
    code: "DEFI",
    name: "DeFi",
    icon: "https://assets-stg.transak.com/images/cryptoCurrency/de-fi_small.png",
    network: "ethereum",
    decimals: 18,
    min_amount: null,
    max_amount: null,
  ...
  },
  {
    code: "DFI",
    name: "DeFiChain",
    icon: "https://assets-stg.transak.com/images/cryptoCurrency/defichain_small.png",
    network: "mainnet",
    decimals: 18,
    min_amount: null,
    max_amount: null,
  ...
  },
  {
    ...
    icon: "https://assets-stg.transak.com/images/cryptoCurrency/defipulse-index_small.png",
    network: "ethereum",
    decimals: 18,
    min_amount: null,
    max_amount: null,
  ...
  },
  {
    code: "MANA",
    name: "Decentraland",
    icon: "https://assets-stg.transak.com/images/cryptoCurrency/decentraland_small.png",
    network: "ethereum",
    decimals: 18,
    min_amount: null,
    max_amount: null,
  ...
  },
  {
    code: "DFYN",
    name: "Dfyn Network",
    icon: "https://assets-stg.transak.com/images/cryptoCurrency/dfyn-network_small.png",
    network: "polygon",
    decimals: 18,
    min_amount: null,
    max_amount: null,
  ...
  },
  {
    code: "DOCK",
    name: "Dock",
    icon: "https://assets-stg.transak.com/images/cryptoCurrency/dock_small.png",
    network: "dock",
    decimals: null,
    min_amount: null,
    max_amount: null,
  ...
  },
  {
    code: "DOGA",
    name: "Dogami",
    icon: "https://assets-stg.transak.com/images/cryptoCurrency/dogami_small.png",
    network: "polygon",
    decimals: 18,
    min_amount: null,
    max_amount: null,
  ...
  },
  {
    code: "EOS",
    name: "EOS",
    icon: "https://assets-stg.transak.com/images/cryptoCurrency/eos_small.png",
    network: "mainnet",
    decimals: 18,
    min_amount: null,
    max_amount: null,
  ...
  },
  {
    code: "EURA",
    name: "EURA",
    icon: "https://assets-stg.transak.com/images/cryptoCurrency/ageur_small.png",
    network: "ethereum",
    decimals: 18,
    min_amount: null,
    max_amount: null,
  ...
  },
  {
    code: "EURC",
    name: "EURC",
    icon: "https://assets-stg.transak.com/images/cryptoCurrency/euro-coin_small.png",
    network: "ethereum",
    decimals: 18,
    min_amount: null,
    max_amount: null,
  ...
  },
  {
    code: "ENJ",
    name: "Enjin Coin",
    icon: "https://assets-stg.transak.com/images/cryptoCurrency/enjincoin_small.png",
    network: "ethereum",
    decimals: 18,
    min_amount: null,
    max_amount: null,
  ...
  },
  {
    ...
    icon: "https://assets-stg.transak.com/images/cryptoCurrency/ethereum-classic_small.png",
    network: "mainnet",
    decimals: 18,
    min_amount: null,
    max_amount: null,
  ...
  },
  {
    ...
    icon: "https://assets-stg.transak.com/images/cryptoCurrency/ethernity-chain_small.png",
    network: "ethereum",
    decimals: 18,
    min_amount: null,
    max_amount: null,
  ...
  },
  {
    code: "EURT",
    name: "Euro Tether",
    icon: "https://assets-stg.transak.com/images/cryptoCurrency/tether-eurt_small.png",
    network: "ethereum",
    decimals: 18,
    min_amount: null,
    max_amount: null,
  ...
  },
  {
    code: "EGC",
    name: "EverGrow Coin",
    icon: "https://assets-stg.transak.com/images/cryptoCurrency/evergrowcoin_small.png",
    network: "bsc",
    decimals: 18,
    min_amount: null,
    max_amount: null,
  ...
  },
  {
    code: "EVMOS",
    name: "Evmos",
    icon: "https://assets-stg.transak.com/images/cryptoCurrency/evmos_small.png",
    network: "evmos",
    decimals: 18,
    min_amount: null,
    max_amount: null,
  ...
  },
  {
    code: "FLOKI",
    name: "FLOKI",
    icon: "https://assets-stg.transak.com/images/cryptoCurrency/floki_small.png",
    network: "ethereum",
    decimals: 18,
    min_amount: null,
    max_amount: null,
  ...
  },
  {
    code: "FUSDC",
    name: "Fake USDC",
    icon: "https://assets-stg.transak.com/images/cryptoCurrency/usd-coin_small.png",
    network: "polygon",
    decimals: 18,
    min_amount: null,
    max_amount: null,
  ...
  },
  {
    code: "FTM",
    name: "Fantom",
    icon: "https://assets-stg.transak.com/images/cryptoCurrency/fantom_small.png",
    network: "fantom",
    decimals: 18,
    min_amount: null,
    max_amount: null,
  ...
  },
  {
    code: "FUSD",
    name: "Fantom USD",
    icon: "https://assets-stg.transak.com/images/cryptoCurrency/fantom-usd_small.png",
    network: "flow",
    decimals: 8,
    min_amount: null,
    max_amount: null,
  ...
  },
  {
    code: "FTN",
    name: "Fasttoken",
    icon: "https://assets-stg.transak.com/images/cryptoCurrency/fasttoken_small.png",
    network: "bahamut",
    decimals: 18,
    min_amount: null,
    max_amount: null,
  ...
  },
  {
    code: "FEAR",
    name: "Fear",
    icon: "https://assets-stg.transak.com/images/cryptoCurrency/fear_small.png",
    network: "polygon",
    decimals: 18,
    min_amount: null,
    max_amount: null,
  ...
  },
  {
    ...
    icon: "https://assets-stg.transak.com/images/cryptoCurrency/first-digital-usd_small.jpg",
    network: "ethereum",
    decimals: 18,
    min_amount: null,
    max_amount: null,
  ...
  },
  {
    code: "FLR",
    name: "Flare",
    icon: "https://assets-stg.transak.com/images/cryptoCurrency/flare-networks_small.png",
    network: "flare",
    decimals: 18,
    min_amount: null,
    max_amount: null,
  ...
  },
  {
    code: "FLOW",
    name: "Flow",
    icon: "https://assets-stg.transak.com/images/cryptoCurrency/flow_small.png",
    network: "flow",
    decimals: 8,
    min_amount: null,
    max_amount: null,
  ...
  },
  {
    ...
    icon: "https://assets-stg.transak.com/images/cryptoCurrency/foodchain-global_small.png",
    network: "polygon",
    decimals: 18,
    min_amount: null,
    max_amount: null,
  ...
  },
  {
    code: "FRTN",
    name: "Fortune Token",
    icon: "https://assets-dev.transak.com/images/cryptoCurrency/ebisusbay-fortune_small.png",
    network: "cronos",
    decimals: 18,
    min_amount: null,
    max_amount: null,
  ...
  },
  {
    code: "FRAX",
    name: "Frax",
    icon: "https://assets-stg.transak.com/images/cryptoCurrency/frax_small.png",
    network: "ethereum",
    decimals: 18,
    min_amount: null,
    max_amount: null,
  ...
  },
  {
    code: "FUSE",
    name: "Fuse",
    icon: "https://assets-stg.transak.com/images/cryptoCurrency/fuse-network-token_small.png",
    network: "fuse",
    decimals: 18,
    min_amount: null,
    max_amount: null,
  ...
  },
  {
    code: "GMEE",
    name: "GAMEE",
    icon: "https://assets-stg.transak.com/images/cryptoCurrency/gamee_small.png",
    network: "polygon",
    decimals: 18,
    min_amount: null,
    max_amount: null,
  ...
  },
  {
    code: "GMX",
    name: "GMX",
    icon: "https://assets-stg.transak.com/images/cryptoCurrency/gmx_small.png",
    network: "arbitrum",
    decimals: 18,
    min_amount: null,
    max_amount: null,
  ...
  },
  {
    code: "GARI",
    name: "Gari Network",
    icon: "https://assets-stg.transak.com/images/cryptoCurrency/gari-network_small.png",
    network: "solana",
    decimals: null,
    min_amount: null,
    max_amount: null,
  ...
  },
  {
    code: "GTH",
    name: "Gather",
    icon: "https://assets-stg.transak.com/images/cryptoCurrency/gather_small.png",
    network: "ethereum",
    decimals: 18,
    min_amount: null,
    max_amount: null,
  ...
  },
  {
    code: "CGT",
    name: "Gelato",
    icon: "https://assets-stg.transak.com/images/cryptoCurrency/gelato_small.png",
    network: "arbitrum",
    decimals: 18,
    min_amount: null,
    max_amount: null,
  ...
  },
  {
    code: "GTC",
    name: "Gitcoin",
    icon: "https://assets-stg.transak.com/images/cryptoCurrency/gitcoin_small.png",
    network: "ethereum",
    decimals: 18,
    min_amount: null,
    max_amount: null,
  ...
  },
  {
    code: "GLM",
    name: "Golem",
    icon: "https://assets-stg.transak.com/images/cryptoCurrency/golem_small.png",
    network: "ethereum",
    decimals: 18,
    min_amount: null,
    max_amount: null,
  ...
  },
  {
    code: "ONE",
    name: "Harmony",
    icon: "https://assets-stg.transak.com/images/cryptoCurrency/harmony_small.png",
    network: "mainnet",
    decimals: 18,
    min_amount: null,
    max_amount: null,
  ...
  },
  {
    code: "HTR",
    name: "Hathor",
    icon: "https://assets-stg.transak.com/images/cryptoCurrency/hathor_small.png",
    network: "mainnet",
    decimals: 2,
    min_amount: null,
    max_amount: null,
  ...
  },
  {
    code: "HBAR",
    name: "Hedera",
    icon: "https://assets-stg.transak.com/images/cryptoCurrency/hedera-hashgraph_small.png",
    network: "mainnet",
    decimals: 8,
    min_amount: null,
    max_amount: null,
  ...
  },
  {
    code: "HIVE",
    name: "Hive",
    icon: "https://assets-stg.transak.com/images/cryptoCurrency/hive_small.png",
    network: "mainnet",
    decimals: 3,
    min_amount: null,
    max_amount: null,
  ...
  },
  {
    code: "ZEN",
    name: "Horizen",
    icon: "https://assets-stg.transak.com/images/cryptoCurrency/zencash_small.png",
    network: "mainnet",
    decimals: 8,
    min_amount: null,
    max_amount: null,
  ...
  },
  {
    code: "IGG",
    name: "IG Gold",
    icon: "https://assets-stg.transak.com/images/cryptoCurrency/ig-gold_small.png",
    network: "polygon",
    decimals: 18,
    min_amount: null,
    max_amount: null,
  ...
  },
  {
    code: "IOST",
    name: "IOST",
    icon: "https://assets-stg.transak.com/images/cryptoCurrency/iostoken_small.png",
    network: "mainnet",
    decimals: 8,
    min_amount: null,
    max_amount: null,
  ...
  },
  {
    code: "IOTA",
    name: "IOTA",
    icon: "https://assets-stg.transak.com/images/cryptoCurrency/iota_small.png",
    network: "miota",
    decimals: null,
    min_amount: null,
    max_amount: null,
  ...
  },
  {
    code: "IBZ",
    name: "Ibiza Token",
    icon: "https://assets-stg.transak.com/images/cryptoCurrency/ibiza-token_small.png",
    network: "ethereum",
    decimals: 18,
    min_amount: null,
    max_amount: null,
  ...
  },
  {
    code: "IMX",
    name: "Immutable X",
    icon: "https://assets-dev.transak.com/images/cryptoCurrency/immutable-x_small.png",
    network: "immutable",
    decimals: 6,
    min_amount: null,
    max_amount: null,
  ...
  },
  {
    code: "INJ",
    name: "Injective",
    icon: "https://assets-stg.transak.com/images/cryptoCurrency/injective-protocol_small.png",
    network: "injective",
    decimals: 18,
    min_amount: null,
    max_amount: null,
  ...
  },
  {
    ...
    icon: "https://assets-stg.transak.com/images/cryptoCurrency/internet-computer_small.png",
    network: "mainnet",
    decimals: 8,
    min_amount: null,
    max_amount: null,
  ...
  },
  {
    code: "IOTX",
    name: "IoTeX",
    icon: "https://assets-stg.transak.com/images/cryptoCurrency/iotex_small.png",
    network: "iotx",
    decimals: 18,
    min_amount: null,
    max_amount: null,
  ...
  },
  {
    code: "JOE",
    name: "JOE",
    icon: "https://assets-stg.transak.com/images/cryptoCurrency/joe_small.png",
    network: "avaxcchain",
    decimals: 18,
    min_amount: null,
    max_amount: null,
  ...
  },
  {
    code: "KDA",
    name: "Kadena",
    icon: "https://assets-stg.transak.com/images/cryptoCurrency/kadena_small.jpg",
    network: "mainnet",
    decimals: 12,
    min_amount: null,
    max_amount: null,
  ...
  },
  {
    code: "KAVA",
    name: "Kava",
    icon: "https://assets-stg.transak.com/images/cryptoCurrency/kava_small.png",
    network: "mainnet",
    decimals: 6,
    min_amount: null,
    max_amount: null,
  ...
  },
  {
    code: "KLIMA",
    name: "Klima DAO",
    icon: "https://assets-stg.transak.com/images/cryptoCurrency/klima-dao_small.png",
    network: "polygon",
    decimals: 18,
    min_amount: null,
    max_amount: null,
  ...
  },
  {
    code: "KSM",
    name: "Kusama",
    icon: "https://assets-stg.transak.com/images/cryptoCurrency/kusama_small.jpg",
    network: "mainnet",
    decimals: 12,
    min_amount: null,
    max_amount: null,
  ...
  },
  {
    code: "LYX",
    name: "LUKSO",
    icon: "https://assets-stg.transak.com/images/cryptoCurrency/lukso-token-2_small.png",
    network: "lukso",
    decimals: 18,
    min_amount: null,
    max_amount: null,
  ...
  },
  {
    ...
    icon: "https://assets-stg.transak.com/images/cryptoCurrency/staked-ether_small.png",
    network: "ethereum",
    decimals: 18,
    min_amount: null,
    max_amount: null,
  ...
  },
  {
    code: "LTC",
    name: "Litecoin",
    icon: "https://assets-stg.transak.com/images/cryptoCurrency/binance-peg-litecoin_small.png",
    network: "mainnet",
    decimals: 8,
    min_amount: null,
    max_amount: null,
  ...
  },
  {
    code: "LOOKS",
    name: "LooksRare",
    icon: "https://assets-stg.transak.com/images/cryptoCurrency/looksrare_small.png",
    network: "ethereum",
    decimals: 18,
    min_amount: null,
    max_amount: null,
  ...
  },
  {
    code: "LCR",
    name: "Lucro",
    icon: "https://assets-stg.transak.com/images/cryptoCurrency/lucro_small.png",
    network: "bsc",
    decimals: 18,
    min_amount: null,
    max_amount: null,
  ...
  },
  {
    code: "MNET",
    name: "MINE Network",
    icon: "https://assets-stg.transak.com/images/cryptoCurrency/mine-network_small.png",
    network: "ethereum",
    decimals: 18,
    min_amount: null,
    max_amount: null,
  ...
  },
  {
    code: "MPRO",
    name: "MPRO Lab",
    icon: "https://assets-stg.transak.com/images/cryptoCurrency/mpro-lab_small.jpg",
    network: "ethereum",
    decimals: 18,
    min_amount: null,
    max_amount: null,
  ...
  },
  {
    ...
    icon: "https://assets-stg.transak.com/images/cryptoCurrency/magic-internet-money_small.png",
    network: "ethereum",
    decimals: 18,
    min_amount: null,
    max_amount: null,
  ...
  },
  {
    code: "MKR",
    name: "Maker",
    icon: "https://assets-stg.transak.com/images/cryptoCurrency/maker_small.png",
    network: "ethereum",
    decimals: 18,
    min_amount: null,
    max_amount: null,
  ...
  },
  {
    code: "MNT",
    name: "Mantle",
    icon: "https://assets-stg.transak.com/images/cryptoCurrency/mantle_small.png",
    network: "mantle",
    decimals: 18,
    min_amount: null,
    max_amount: null,
  ...
  },
  {
    code: "MASK",
    name: "Mask Network",
    icon: "https://assets-stg.transak.com/images/cryptoCurrency/mask-network_small.png",
    network: "ethereum",
    decimals: 18,
    min_amount: null,
    max_amount: null,
  ...
  },
  {
    code: "MSU",
    name: "MetaSoccer",
    icon: "https://assets-stg.transak.com/images/cryptoCurrency/metasoccer_small.jpg",
    network: "polygon",
    decimals: 18,
    min_amount: null,
    max_amount: null,
  ...
  },
  {
    code: "MCADE",
    name: "Metacade",
    icon: "https://assets-stg.transak.com/images/cryptoCurrency/metacade_small.png",
    network: "ethereum",
    decimals: 18,
    min_amount: null,
    max_amount: null,
  ...
  },
  {
    ...
    icon: "https://assets-stg.transak.com/images/cryptoCurrency/metaverse-network-pioneer_small.png",
    network: "pioneer",
    decimals: 18,
    min_amount: null,
    max_amount: null,
  ...
  },
  {
    code: "MINDS",
    name: "Minds",
    icon: "https://assets-stg.transak.com/images/cryptoCurrency/minds_small.png",
    network: "ethereum",
    decimals: 18,
    min_amount: null,
    max_amount: null,
  ...
  },
  {
    code: "MOB",
    name: "MobileCoin",
    icon: "https://assets-stg.transak.com/images/cryptoCurrency/mobilecoin_small.png",
    network: "mainnet",
    decimals: 8,
    min_amount: null,
    max_amount: null,
  ...
  },
  {
    code: "GLMR",
    name: "Moonbeam",
    icon: "https://assets-stg.transak.com/images/cryptoCurrency/moonbeam_small.png",
    network: "mainnet",
    decimals: 18,
    min_amount: null,
    max_amount: null,
  ...
  },
  {
    code: "MOVR",
    name: "Moonriver",
    icon: "https://assets-stg.transak.com/images/cryptoCurrency/moonriver_small.png",
    network: "moonriver",
    decimals: 18,
    min_amount: null,
    max_amount: null,
  ...
  },
  {
    code: "EGLD",
    name: "MultiversX",
    icon: "https://assets-stg.transak.com/images/cryptoCurrency/elrond-erd-2_small.png",
    network: "mainnet",
    decimals: 12,
    min_amount: null,
    max_amount: null,
  ...
  },
  {
    code: "MUST",
    name: "Must",
    icon: "https://assets-stg.transak.com/images/cryptoCurrency/must_small.png",
    network: "polygon",
    decimals: 18,
    min_amount: null,
    max_amount: null,
  ...
  },
  {
    code: "XEM",
    name: "NEM",
    icon: "https://assets-stg.transak.com/images/cryptoCurrency/nem_small.png",
    network: "mainnet",
    decimals: 6,
    min_amount: null,
    max_amount: null,
  ...
  },
  {
    code: "NEAR",
    name: "Near",
    icon: "https://assets-stg.transak.com/images/cryptoCurrency/near_small.png",
    network: "mainnet",
    decimals: 24,
    min_amount: null,
    max_amount: null,
  ...
  },
  {
    code: "CKB",
    name: "Nervos Network",
    icon: "https://assets-stg.transak.com/images/cryptoCurrency/nervos-network_small.png",
    network: "nervos",
    decimals: 8,
    min_amount: null,
    max_amount: null,
  ...
  },
  {
    code: "NOT",
    name: "Notcoin",
    icon: "https://assets-stg.transak.com/images/cryptoCurrency/notcoin_small.jpg",
    network: "ton",
    decimals: 9,
    min_amount: null,
    max_amount: null,
  ...
  },
  {
    code: "OKT",
    name: "OKC",
    icon: "https://assets-stg.transak.com/images/cryptoCurrency/oec-token_small.png",
    network: "okxchain",
    decimals: 18,
    min_amount: null,
    max_amount: null,
  ...
  },
  {
    code: "ROSE",
    name: "Oasis Network",
    icon: "https://assets-stg.transak.com/images/cryptoCurrency/oasis-network_small.png",
    network: "oasis",
    decimals: 18,
    min_amount: null,
    max_amount: null,
  ...
  },
  {
    code: "OAS",
    name: "Oasys",
    icon: "https://assets-stg.transak.com/images/cryptoCurrency/oasys_small.png",
    network: "oasys",
    decimals: null,
    min_amount: null,
    max_amount: null,
  ...
  },
  {
    code: "OSMO",
    name: "Osmosis",
    icon: "https://assets-stg.transak.com/images/cryptoCurrency/osmosis_small.png",
    network: "osmosis",
    decimals: 6,
    min_amount: null,
    max_amount: null,
  ...
  },
  {
    code: "PRIMAL",
    name: "PRIMAL",
    icon: "https://assets-stg.transak.com/images/cryptoCurrency/primal-b3099cd0-995a-4311-80d5-9c133153b38e_small.jpg",
    network: "bsc",
    decimals: 18,
    min_amount: null,
    max_amount: null,
  ...
  },
  {
    ...
    icon: "https://assets-stg.transak.com/images/cryptoCurrency/partisia-blockchain_small.png",
  ...
  },
  {
    code: "PYUSD",
    name: "PayPal USD",
    icon: "https://assets-stg.transak.com/images/cryptoCurrency/paypal-usd_small.png",
    network: "ethereum",
    decimals: 18,
    min_amount: null,
    max_amount: null,
  ...
  },
  {
    ...
    icon: "https://assets-stg.transak.com/images/cryptoCurrency/peanut-the-squirrel_small.jpg",
    network: "solana",
    decimals: 6,
    min_amount: null,
    max_amount: null,
  ...
  },
  {
    code: "PEPE",
    name: "Pepe",
    icon: "https://assets-stg.transak.com/images/cryptoCurrency/pepe_small.jpg",
    network: "ethereum",
    decimals: 18,
    min_amount: null,
    max_amount: null,
  ...
  },
  {
    code: "PZP",
    name: "PlayZap",
    icon: "https://assets-stg.transak.com/images/cryptoCurrency/playzap_small.png",
    network: "bsc",
    decimals: 18,
    min_amount: null,
    max_amount: null,
  ...
  },
  {
    code: "PLOT",
    name: "PlotX",
    icon: "https://assets-stg.transak.com/images/cryptoCurrency/plotx_small.jpg",
    network: "ethereum",
    decimals: 18,
    min_amount: null,
    max_amount: null,
  ...
  },
  {
    code: "DOT",
    name: "Polkadot",
    icon: "https://assets-stg.transak.com/images/cryptoCurrency/polkadot_small.png",
    network: "mainnet",
    decimals: 10,
    min_amount: null,
    max_amount: null,
  ...
  },
  {
    code: "POLS",
    name: "Polkastarter",
    icon: "https://assets-stg.transak.com/images/cryptoCurrency/polkastarter_small.png",
    network: "ethereum",
    decimals: 18,
    min_amount: null,
    max_amount: null,
  ...
  },
  {
    code: "MATIC",
    name: "Polygon",
    icon: "https://assets-stg.transak.com/images/cryptoCurrency/matic-network_small.png",
    network: "polygon",
    decimals: 18,
    min_amount: null,
    max_amount: null,
  ...
  },
  {
    ...
    icon: "https://assets-stg.transak.com/images/cryptoCurrency/polygon-ecosystem-token_small.png",
    network: "polygon",
    decimals: 18,
    min_amount: null,
    max_amount: null,
  ...
  },
  {
    code: "PBX",
    name: "Probinex",
    icon: "https://assets-stg.transak.com/images/cryptoCurrency/probinex_small.png",
    network: "bsc",
    decimals: 18,
    min_amount: null,
    max_amount: null,
  ...
  },
  {
    code: "QI",
    name: "Qi Dao",
    icon: "https://assets-stg.transak.com/images/cryptoCurrency/qi-dao_small.png",
    network: "polygon",
    decimals: 18,
    min_amount: null,
    max_amount: null,
  ...
  },
  {
    code: "QUICK",
    name: "Quickswap",
    icon: "https://assets-stg.transak.com/images/cryptoCurrency/quick_small.png",
    network: "polygon",
    decimals: 18,
    min_amount: null,
    max_amount: null,
  ...
  },
  {
    code: "REVV",
    name: "REVV",
    icon: "https://assets-stg.transak.com/images/cryptoCurrency/revv_small.png",
    network: "polygon",
    decimals: 18,
    min_amount: null,
    max_amount: null,
  ...
  },
  {
    code: "USDR",
    name: "RabbitDollar",
    icon: "https://assets-stg.transak.com/images/cryptoCurrency/tether_small.png",
    network: "ethereum",
    decimals: 6,
    min_amount: null,
    max_amount: null,
  ...
  },
  {
    code: "REVU",
    name: "Revuto",
    icon: "https://assets-stg.transak.com/images/cryptoCurrency/revuto_small.png",
    network: "mainnet",
    decimals: null,
    min_amount: null,
    max_amount: null,
  ...
  },
  {
    code: "RON",
    name: "Ronin",
    icon: "https://assets-stg.transak.com/images/cryptoCurrency/ronin_small.jpg",
    network: "ronin",
    decimals: 18,
    min_amount: null,
    max_amount: null,
  ...
  },
  {
    code: "RBTC",
    name: "Rootstock RSK",
    icon: "https://assets-stg.transak.com/images/cryptoCurrency/rootstock_small.png",
    network: "mainnet",
    decimals: 18,
    min_amount: null,
    max_amount: null,
  ...
  },
  {
    code: "SWAPP",
    name: "SWAPP Protocol",
    icon: "https://assets-stg.transak.com/images/cryptoCurrency/swapp_small.png",
    network: "ethereum",
    decimals: 18,
    min_amount: null,
    max_amount: null,
  ...
  },
  {
    code: "QUARTZ",
    name: "Sandclock",
    icon: "https://assets-stg.transak.com/images/cryptoCurrency/sandclock_small.jpg",
    network: "ethereum",
    decimals: 18,
    min_amount: null,
    max_amount: null,
  ...
  },
  {
    code: "SCRT",
    name: "Secret",
    icon: "https://assets-stg.transak.com/images/cryptoCurrency/secret_small.png",
    network: "mainnet",
    decimals: 6,
    min_amount: null,
    max_amount: null,
  ...
  },
  {
    code: "SEI",
    name: "Sei",
    icon: "https://assets-stg.transak.com/images/cryptoCurrency/sei-network_small.png",
    network: "sei",
    decimals: 18,
    min_amount: null,
    max_amount: null,
  ...
  },
  {
    code: "SHIB",
    name: "Shiba Inu",
    icon: "https://assets-stg.transak.com/images/cryptoCurrency/shiba-inu_small.png",
    network: "ethereum",
    decimals: 18,
    min_amount: null,
    max_amount: null,
  ...
  },
  {
    code: "SDN",
    name: "Shiden Network",
    icon: "https://assets-stg.transak.com/images/cryptoCurrency/shiden_small.png",
    network: "Shiden",
    decimals: 18,
    min_amount: null,
    max_amount: null,
  ...
  },
  {
    code: "SPI",
    name: "Shopping.io",
    icon: "https://assets-stg.transak.com/images/cryptoCurrency/shopping-io_small.png",
    network: "ethereum",
    decimals: 18,
    min_amount: null,
    max_amount: null,
  ...
  },
  {
    ...
    icon: "https://assets-stg.transak.com/images/cryptoCurrency/smooth-love-potion_small.png",
    network: "mainnet",
    decimals: null,
    min_amount: null,
    max_amount: null,
  ...
  },
  {
    code: "SOL",
    name: "Solana",
    icon: "https://assets-stg.transak.com/images/cryptoCurrency/solana_small.png",
    network: "solana",
    decimals: 9,
    min_amount: null,
    max_amount: null,
  ...
  },
  {
    ...
    icon: "https://assets-stg.transak.com/images/cryptoCurrency/sperax_small.png",
    network: "arbitrum",
    decimals: 18,
    min_amount: null,
    max_amount: null,
  ...
  },
  {
    code: "USDS",
    name: "Sperax USD",
    icon: "https://assets-stg.transak.com/images/cryptoCurrency/sperax-usd_small.png",
    network: "arbitrum",
    decimals: 18,
    min_amount: null,
    max_amount: null,
  ...
  },
  {
    code: "SPS",
    name: "Splintershards",
    icon: "https://assets-stg.transak.com/images/cryptoCurrency/splinterlands_small.png",
    network: "bsc",
    decimals: 18,
    min_amount: null,
    max_amount: null,
  ...
  },
  {
    code: "STX",
    name: "Stacks",
    icon: "https://assets-stg.transak.com/images/cryptoCurrency/blockstack_small.png",
    network: "mainnet",
    decimals: 6,
    min_amount: null,
    max_amount: null,
  ...
  },
  {
    code: "XLM",
    name: "Stellar",
    icon: "https://assets-stg.transak.com/images/cryptoCurrency/stellar_small.png",
    network: "mainnet",
    decimals: 7,
    min_amount: null,
    max_amount: null,
  ...
  },
  {
    code: "STRX",
    name: "StrikeX",
    icon: "https://assets-stg.transak.com/images/cryptoCurrency/strikecoin_small.png",
    network: "bsc",
    decimals: 18,
    min_amount: null,
    max_amount: null,
  ...
  },
  {
    code: "SUI",
    name: "Sui",
    icon: "https://assets-stg.transak.com/images/cryptoCurrency/sui_small.png",
    network: "sui",
    decimals: null,
    min_amount: null,
    max_amount: null,
  ...
  },
  {
    code: "SUPER",
    name: "SuperVerse",
    icon: "https://assets-stg.transak.com/images/cryptoCurrency/superfarm_small.png",
    network: "ethereum",
    decimals: 18,
    min_amount: null,
    max_amount: null,
  ...
  },
  {
    code: "SUSHI",
    name: "Sushi",
    icon: "https://assets-stg.transak.com/images/cryptoCurrency/sushi_small.png",
    network: "ethereum",
    decimals: 18,
    min_amount: null,
    max_amount: null,
  ...
  },
  {
    code: "SWEAT",
    name: "Sweat Economy",
    icon: "https://assets-stg.transak.com/images/cryptoCurrency/sweatcoin_small.jpg",
    network: "near",
    decimals: 18,
    min_amount: null,
    max_amount: null,
  ...
  },
  {
    code: "TRX",
    name: "TRON",
    icon: "https://assets-stg.transak.com/images/cryptoCurrency/tron_small.png",
    network: "mainnet",
    decimals: 6,
    min_amount: null,
    max_amount: null,
  ...
  },
  {
    code: "TAMA",
    name: "Tamadoge",
    icon: "https://assets-stg.transak.com/images/cryptoCurrency/tamadoge_small.png",
    network: "ethereum",
    decimals: 18,
    min_amount: null,
    max_amount: null,
  ...
  },
  {
    code: "LUNA",
    name: "Terra",
    icon: "https://assets-stg.transak.com/images/cryptoCurrency/terra-luna-2_small.png",
    network: "terra",
    decimals: 18,
    min_amount: null,
    max_amount: null,
  ...
  },
  {
    code: "XTZ",
    name: "Tezos",
    icon: "https://assets-stg.transak.com/images/cryptoCurrency/tezos_small.png",
    network: "mainnet",
    decimals: 6,
    min_amount: null,
    max_amount: null,
  ...
  },
  {
    code: "SAND",
    name: "The Sandbox",
    icon: "https://assets-stg.transak.com/images/cryptoCurrency/the-sandbox_small.png",
    network: "ethereum",
    decimals: 18,
    min_amount: null,
    max_amount: null,
  ...
  },
  {
    code: "TT",
    name: "ThunderCore",
    icon: "https://assets-stg.transak.com/images/cryptoCurrency/thunder-token_small.png",
    network: "thundercore",
    decimals: 18,
    min_amount: null,
    max_amount: null,
  ...
  },
  {
    code: "TON",
    name: "Toncoin",
    icon: "https://assets-stg.transak.com/images/cryptoCurrency/the-open-network_small.png",
    network: "ton",
    decimals: 9,
    min_amount: null,
    max_amount: null,
  ...
  },
  {
    code: "TOWER",
    name: "Tower",
    icon: "https://assets-stg.transak.com/images/cryptoCurrency/tower_small.png",
    network: "polygon",
    decimals: 18,
    min_amount: null,
    max_amount: null,
  ...
  },
  {
    code: "TSX",
    name: "TradeStars",
    icon: "https://assets-stg.transak.com/images/cryptoCurrency/tradestars_small.png",
    network: "ethereum",
    decimals: 18,
    min_amount: null,
    max_amount: null,
  ...
  },
  {
    code: "TWT",
    name: "Trust Wallet",
    icon: "https://assets-stg.transak.com/images/cryptoCurrency/trust-wallet-token_small.png",
    network: "bsc",
    decimals: 18,
    min_amount: null,
    max_amount: null,
  ...
  },
  {
    code: "SWAP",
    name: "Trustswap",
    icon: "https://assets-stg.transak.com/images/cryptoCurrency/trustswap_small.png",
    network: "ethereum",
    decimals: 18,
    min_amount: null,
    max_amount: null,
  ...
  },
  {
    code: "ULX",
    name: "ULTRON",
    icon: "https://assets-stg.transak.com/images/cryptoCurrency/ultron_small.jpg",
    network: "bsc",
    decimals: 18,
    min_amount: null,
    max_amount: null,
  ...
  },
  {
    ...
    icon: "https://assets-stg.transak.com/images/cryptoCurrency/ultimate-champions_small.png",
    network: "bsc",
    decimals: 18,
    min_amount: null,
    max_amount: null,
  ...
  },
  {
    code: "UNI",
    name: "Uniswap",
    icon: "https://assets-stg.transak.com/images/cryptoCurrency/uniswap_small.png",
    network: "ethereum",
    decimals: 18,
    min_amount: null,
    max_amount: null,
  ...
  },
  {
    code: "UTK",
    name: "Utrust",
    icon: "https://assets-stg.transak.com/images/cryptoCurrency/utrust_small.png",
    network: "multiversx",
    decimals: 18,
    min_amount: null,
    max_amount: null,
  ...
  },
  {
    code: "VET",
    name: "VeChain",
    icon: "https://assets-stg.transak.com/images/cryptoCurrency/vechain_small.png",
    network: "vechain",
    decimals: 18,
    min_amount: null,
    max_amount: null,
  ...
  },
  {
    code: "VTHO",
    name: "VeThor",
    icon: "https://assets-stg.transak.com/images/cryptoCurrency/vethor-token_small.png",
    network: "vechain",
    decimals: 18,
    min_amount: null,
    max_amount: null,
  ...
  },
  {
    code: "VLX",
    name: "Velas",
    icon: "https://assets-stg.transak.com/images/cryptoCurrency/velas_small.png",
    network: "velasevm",
    decimals: null,
    min_amount: null,
    max_amount: null,
  ...
  },
  {
    code: "VEXT",
    name: "Veloce",
    icon: "https://assets-stg.transak.com/images/cryptoCurrency/veloce-vext_small.png",
    network: "polygon",
    decimals: 18,
    min_amount: null,
    max_amount: null,
  ...
  },
  {
    code: "VRA",
    name: "Verasity",
    icon: "https://assets-stg.transak.com/images/cryptoCurrency/verasity_small.png",
    network: "ethereum",
    decimals: 18,
    min_amount: null,
    max_amount: null,
  ...
  },
  {
    code: "VERSE",
    name: "Verse",
    icon: "https://assets-stg.transak.com/images/cryptoCurrency/verse-bitcoin_small.png",
    network: "ethereum",
    decimals: 18,
    min_amount: null,
    max_amount: null,
  ...
  },
  {
    code: "WAXP",
    name: "WAX",
    icon: "https://assets-stg.transak.com/images/cryptoCurrency/wax_small.png",
    network: "wax",
    decimals: 8,
    min_amount: null,
    max_amount: null,
  ...
  },
  {
    code: "WETH",
    name: "WETH",
    icon: "https://assets-stg.transak.com/images/cryptoCurrency/weth_small.png",
    network: "polygon",
    decimals: 18,
    min_amount: null,
    max_amount: null,
  ...
  },
  {
    code: "WAN",
    name: "Wanchain",
    icon: "https://assets-stg.transak.com/images/cryptoCurrency/wanchain_small.png",
    network: "wanchain",
    decimals: 18,
    min_amount: null,
    max_amount: null,
  ...
  },
  {
    code: "WRX",
    name: "WazirX",
    icon: "https://assets-stg.transak.com/images/cryptoCurrency/wazirx_small.png",
    network: "bsc",
    decimals: 18,
    min_amount: null,
    max_amount: null,
  ...
  },
  {
    ...
    icon: "https://assets-stg.transak.com/images/cryptoCurrency/wrapped-bitcoin_small.png",
    network: "ethereum",
    decimals: 8,
    min_amount: null,
    max_amount: null,
  ...
  },
  {
    code: "XCAD",
    name: "XCAD Network",
    icon: "https://assets-stg.transak.com/images/cryptoCurrency/xcad-network_small.png",
    network: "zil",
    decimals: 18,
    min_amount: null,
    max_amount: null,
  ...
  },
  {
    code: "XDC",
    name: "XDC Network",
    icon: "https://assets-stg.transak.com/images/cryptoCurrency/xdce-crowd-sale_small.png",
    network: "xinfin",
    decimals: 18,
    min_amount: null,
    max_amount: null,
  ...
  },
  {
    code: "XDEFI",
    name: "XDEFI",
    icon: "https://assets-stg.transak.com/images/cryptoCurrency/xdefi_small.png",
    network: "ethereum",
    decimals: 18,
    min_amount: null,
    max_amount: null,
  ...
  },
  {
    code: "XRP",
    name: "XRP",
    icon: "https://assets-stg.transak.com/images/cryptoCurrency/ripple_small.png",
    network: "mainnet",
    decimals: 6,
    min_amount: null,
    max_amount: null,
  ...
  },
  {
    code: "YLD",
    name: "Yield",
    icon: "https://assets-stg.transak.com/images/cryptoCurrency/yield_small.png",
    network: "ethereum",
    decimals: 18,
    min_amount: null,
    max_amount: null,
  ...
  },
  {
    code: "ZED",
    name: "ZED RUN",
    icon: "https://assets-stg.transak.com/images/cryptoCurrency/zed-run_small.png",
    network: "polygon",
    decimals: 18,
    min_amount: null,
    max_amount: null,
  ...
  },
  {
    code: "ZIL",
    name: "Zilliqa",
    icon: "https://assets-stg.transak.com/images/cryptoCurrency/zilliqa_small.png",
    network: "zil",
    decimals: 12,
    min_amount: null,
    max_amount: null,
  ...
  },
  {
    code: "ZPAY",
    name: "ZoidPay",
    icon: "https://assets-stg.transak.com/images/cryptoCurrency/zoid-pay_small.png",
    network: "multiversx",
    decimals: 18,
    min_amount: null,
    max_amount: null,
  ...
  },
  {
    code: "ELF",
    name: "aelf",
    icon: "https://assets-stg.transak.com/images/cryptoCurrency/aelf_small.png",
    network: "aelf",
    decimals: 18,
    min_amount: null,
    max_amount: null,
  ...
  },
  {
    code: "STXEM",
    name: "stakedXEM",
    icon: "https://assets-stg.transak.com/images/cryptoCurrency/stakedxem_small.png",
    network: "ethereum",
    decimals: 18,
    min_amount: null,
    max_amount: null,
  ...
  },
  {
    code: "MEX",
    name: "xExchange",
    icon: "https://assets-stg.transak.com/images/cryptoCurrency/maiar-dex_small.png",
    network: "multiversx",
    decimals: 18,
    min_amount: null,
    max_amount: null,
  ...
  },
  {
    code: "ZERC",
    name: "zkRace",
    icon: "https://assets-stg.transak.com/images/cryptoCurrency/derace_small.png",
    network: "ethereum",
    decimals: 18,
    min_amount: null,
    max_amount: null,
...
export const moonpayFiatCurrenciesResponse = [
  {
    code: "AUD",
    name: "Australian Dollar",
    icon: null,
...
export const moonpayCryptoCurrenciesResponse = [
  {
    code: "ZRX",
    name: "0x",
  ...
  },
  {
    code: "1INCH_BSC",
    name: "1inch (BEP-20)",
    icon: "https://static.moonpay.com/widget/currencies/1inch_bsc.svg",
  ...
  },
  {
    code: "1INCH_ETH",
    name: "1inch (ERC-20)",
    icon: "https://static.moonpay.com/widget/currencies/1inch_eth.svg",
    network: "ethereum",
    decimal: 18,
    min_amount: null,
    max_amount: null,
  ...
  },
  {
    code: "AAVE",
    name: "Aave",
    icon: "https://static.moonpay.com/widget/currencies/aave.svg",
    network: "ethereum",
    decimal: 18,
    min_amount: 0.40361,
    max_amount: 180,
  ...
  },
  {
    ...
    icon: "https://static.moonpay.com/widget/currencies/aero_base.svg",
    network: "base",
    decimal: 18,
    min_amount: null,
    max_amount: null,
  ...
  },
  {
    code: "AKT_AKT",
    name: "Akash Network",
    icon: "https://static.moonpay.com/widget/currencies/akt_akt.svg",
    network: "akash",
    decimal: 6,
    min_amount: null,
    max_amount: null,
  ...
  {
    code: "ANIME_ARB",
    name: "Animecoin (Arbitrum)",
    icon: "https://static.moonpay.com/widget/currencies/anime_arb.png",
    network: "arbitrum",
    decimal: 18,
    min_amount: null,
    max_amount: null,
  ...
  {
    code: "ANIME_ETH",
    name: "Animecoin (ERC-20)",
    icon: "https://static.moonpay.com/widget/currencies/anime_eth.png",
    network: "ethereum",
    decimal: 18,
    min_amount: null,
    max_amount: null,
  ...
  },
  {
    code: "APE",
    name: "ApeCoin (ERC-20)",
    icon: "https://static.moonpay.com/widget/currencies/ape.svg",
    network: "ethereum",
    decimal: 18,
    min_amount: 13.95349,
    max_amount: 7500,
  ...
  },
  {
    code: "APT",
    name: "Aptos",
    icon: "https://static.moonpay.com/widget/currencies/aptos.png",
    network: "aptos",
    decimal: 8,
    min_amount: 3.93071,
    max_amount: null,
  ...
  },
  {
    code: "ARB",
    name: "Arbitrum",
    icon: "https://static.moonpay.com/widget/currencies/arb.svg",
    network: "ethereum",
    decimal: 18,
    min_amount: null,
    max_amount: null,
  ...
  {
    code: "ARB_ARB",
    name: "Arbitrum (Arbitrum One)",
    icon: "https://static.moonpay.com/widget/currencies/arb_arb.svg",
    network: "arbitrum",
    decimal: 18,
    min_amount: null,
    max_amount: null,
  ...
  },
  {
    code: "ARKM_ETH",
    name: "Arkham (ERC-20)",
    icon: "https://static.moonpay.com/widget/currencies/arkm_eth.svg",
    network: "ethereum",
    decimal: 18,
    min_amount: null,
    max_amount: null,
  ...
  },
  {
    ...
    icon: "https://static.moonpay.com/widget/currencies/fet_eth.svg",
    network: "ethereum",
    decimal: 18,
    min_amount: null,
    max_amount: null,
  ...
  },
  {
    code: "AXS",
    name: "Axie Infinity",
    icon: "https://static.moonpay.com/widget/currencies/axs.svg",
    network: "ethereum",
    decimal: 18,
    min_amount: 4.56162,
    max_amount: 390,
  ...
  {
    code: "BTT_BSC",
    name: "BitTorrent (BEP-20)",
    icon: "https://static.moonpay.com/widget/currencies/btt_bsc.svg",
    network: "binance_smart_chain",
    decimal: 18,
    min_amount: null,
    max_amount: null,
  ...
  {
    code: "BTTC",
    name: "BitTorrent (Tron)",
    icon: "https://static.moonpay.com/widget/currencies/bttc.svg",
    network: "tron",
    decimal: 18,
    min_amount: 62500000,
    max_amount: null,
  ...
  },
  {
    code: "BLUR_ETH",
    name: "Blur (ERC-20)",
    icon: "https://static.moonpay.com/widget/currencies/blur_eth.avif",
    network: "ethereum",
    decimal: 18,
    min_amount: null,
    max_amount: null,
  ...
  },
  {
    code: "CATI_TON",
    name: "Catizen (Ton)",
    icon: "https://static.moonpay.com/widget/currencies/cati_ton.png",
    network: "ton",
    decimal: 9,
    min_amount: null,
    max_amount: null,
  ...
  },
  {
    ...
    icon: "https://static.moonpay.com/widget/currencies/tia_tia.svg",
    network: "celestia",
    decimal: 18,
    min_amount: null,
    max_amount: null,
  ...
  },
  {
    code: "CELO",
    name: "Celo",
    icon: "https://static.moonpay.com/widget/currencies/celo.svg",
    network: "celo",
    decimal: 18,
    min_amount: 20,
    max_amount: 2000,
  ...
  },
  {
    code: "CUSD",
    name: "Celo Dollar",
    icon: "https://static.moonpay.com/widget/currencies/cusd.svg",
    network: "celo",
    decimal: 18,
    min_amount: 30,
    max_amount: null,
  ...
  {
    code: "CGPT_BSC",
    name: "ChainGPT (BEP-20)",
    icon: "https://static.moonpay.com/widget/currencies/cgpt_bsc.svg",
    network: "bnb_chain",
    decimal: 18,
    min_amount: null,
    max_amount: null,
  ...
  },
  {
    code: "CHZ",
    name: "Chiliz",
    icon: "https://static.moonpay.com/widget/currencies/chz.svg",
    network: "ethereum",
    decimal: 18,
    min_amount: 212,
    max_amount: 2000,
  ...
  },
  {
    code: "COMP",
    name: "Compound",
    icon: "https://static.moonpay.com/widget/currencies/comp.svg",
    network: "ethereum",
    decimal: 18,
    min_amount: 212,
    max_amount: 2000,
  ...
  {
    code: "COOKIE_BSC",
    name: "Cookie DAO (BEP-20)",
    icon: "https://static.moonpay.com/widget/currencies/cookie_bsc.png",
    network: "binance_smart_chain",
    decimal: 18,
    min_amount: null,
    max_amount: null,
  ...
  },
  {
    code: "CRO_ETH",
    name: "Cronos",
    icon: "https://static.moonpay.com/widget/currencies/cro_eth.svg",
    network: "ethereum",
    decimal: 8,
    min_amount: null,
    max_amount: null,
  ...
  {
    code: "CRV_ETH",
    name: "Curve DAO Token (ERC-20)",
    icon: "https://static.moonpay.com/widget/currencies/crv_eth.svg",
    network: "ethereum",
    decimal: 18,
    min_amount: null,
    max_amount: null,
  ...
  },
  {
    ...
    icon: "https://static.moonpay.com/widget/currencies/crv_pol.svg",
    network: "polygon",
    decimal: 18,
    min_amount: null,
    max_amount: null,
  ...
  },
  {
    code: "DOGS_TON",
    name: "DOGS (Ton)",
    icon: "https://static.moonpay.com/widget/currencies/dogs_ton.svg",
    network: "ton",
    decimal: 9,
    min_amount: null,
    max_amount: null,
  ...
  },
  {
    code: "DEGEN_BASE",
    name: "Degen",
    icon: "https://static.moonpay.com/widget/currencies/degen_base.svg",
    network: "base",
    decimal: 18,
    min_amount: null,
    max_amount: null,
  ...
  },
  {
    code: "DGB",
    name: "DigiByte",
    icon: "https://static.moonpay.com/widget/currencies/dgb.svg",
    network: "digibyte",
    decimal: 8,
    min_amount: 20,
    max_amount: 2000,
  ...
  },
  {
    code: "DRIFT_SOL",
    name: "Drift (Solana)",
    icon: "https://static.moonpay.com/widget/currencies/drift_sol.svg",
    network: "solana",
    decimal: 5,
    min_amount: null,
    max_amount: null,
  ...
  },
  {
    code: "EIGEN_ETH",
    name: "EigenLayer",
    icon: "https://static.moonpay.com/widget/currencies/eigen_eth.png",
    network: "ethereum",
    decimal: 18,
    min_amount: null,
    max_amount: null,
  ...
  },
  {
    code: "ENA_ETH",
    name: "Ethena",
    icon: "https://static.moonpay.com/widget/currencies/ena_eth.svg",
    network: "ethereum",
    decimal: 18,
    min_amount: null,
    max_amount: null,
  ...
  },
  {
    ...
    icon: "https://static.moonpay.com/widget/currencies/eth_immutable.svg",
    network: "immutable",
    decimal: 18,
    min_amount: 0.00673,
    max_amount: 8.5,
  ...
  },
  {
    ...
    icon: "https://static.moonpay.com/widget/currencies/eth_sorare.svg",
    network: "sorare",
    decimal: 18,
    min_amount: 0.01562,
    max_amount: null,
  ...
  {
    code: "ETH_WLD",
    name: "Ethereum (Worldchain)",
    icon: "https://static.moonpay.com/widget/currencies/eth_wld.svg",
    network: "worldchain",
    decimal: 18,
    min_amount: null,
    max_amount: null,
  ...
  },
  {
    code: "ETC",
    name: "Ethereum Classic",
    icon: "https://static.moonpay.com/widget/currencies/etc.svg",
  ...
  },
  {
    ...
    icon: "https://static.moonpay.com/widget/currencies/ens.svg",
    network: "ethereum",
    decimal: 18,
    min_amount: null,
    max_amount: null,
  ...
  },
  {
    code: "FTM_FTM",
    name: "Fantom",
    icon: "https://static.moonpay.com/widget/currencies/ftm_ftm.svg",
    network: "fantom",
    decimal: 18,
    min_amount: null,
    max_amount: null,
  ...
  },
  {
    code: "FTM_ETH",
    name: "Fantom (ERC-20)",
    icon: "https://static.moonpay.com/widget/currencies/ftm_eth.svg",
    network: "ethereum",
    decimal: 18,
    min_amount: null,
    max_amount: null,
  ...
  },
  {
    code: "FIL",
    name: "Filecoin",
    icon: "https://static.moonpay.com/widget/currencies/fil.svg",
    network: "filecoin",
    decimal: 18,
    min_amount: 6.80426,
    max_amount: null,
  ...
  },
  {
    code: "FLOKI",
    name: "Floki (ERC-20)",
    icon: "https://static.moonpay.com/widget/currencies/floki.svg",
    network: "ethereum",
    decimal: 9,
    min_amount: 1225490.19608,
    max_amount: null,
    provider: "moonpay",
  },
  {
  ...
  },
  {
    code: "FLOW_FLOW_EVM",
    name: "Flow (EVM)",
    icon: "https://static.moonpay.com/widget/currencies/flow_flow_evm.svg",
    network: "flow_evm",
    decimal: 18,
    min_amount: null,
    max_amount: null,
  ...
  },
  {
    code: "GMT_BSC",
    name: "GMT (BSC)",
    icon: "https://static.moonpay.com/widget/currencies/gmt_bsc.png",
    network: "binance_smart_chain",
    decimal: 8,
    min_amount: null,
    max_amount: null,
  ...
  },
  {
    code: "GMT_ETH",
    name: "GMT (ERC-20)",
    icon: "https://static.moonpay.com/widget/currencies/gmt_eth.svg",
    network: "ethereum",
    decimal: 8,
    min_amount: null,
    max_amount: null,
  ...
  },
  {
    code: "GMT_POLYGON",
    name: "GMT (Polygon)",
    icon: "https://static.moonpay.com/widget/currencies/gmt_polygon.png",
    network: "polygon",
    decimal: 18,
    min_amount: null,
    max_amount: null,
  ...
  },
  {
    code: "GMT_SOL",
    name: "GMT (Solana)",
    icon: "https://static.moonpay.com/widget/currencies/gmt_sol.png",
    network: "solana",
    decimal: 9,
    min_amount: null,
    max_amount: null,
  ...
  },
  {
    ...
    icon: "https://static.moonpay.com/widget/currencies/gods.png",
    network: "ethereum",
    decimal: 18,
    min_amount: 178.99761,
    max_amount: null,
    provider: "moonpay",
  },
  {
  ...
  {
    code: "GRIFFAIN_SOL",
    name: "Griffain (Solana)",
    icon: "https://static.moonpay.com/widget/currencies/griffain_sol.png",
    network: "solana",
    decimal: 4,
    min_amount: null,
    max_amount: null,
  ...
  },
  {
    ...
    icon: "https://static.moonpay.com/widget/currencies/hmstr_ton.png",
    network: "ton",
    decimal: 9,
    min_amount: null,
    max_amount: null,
  ...
  },
  {
    code: "HNT_SOL",
    name: "Helium (Solana)",
    icon: "https://static.moonpay.com/widget/currencies/hnt_sol.svg",
    network: "solana",
    decimal: 8,
    min_amount: null,
    max_amount: null,
  ...
  },
  {
    code: "MIOTA",
    name: "IOTA",
    icon: "https://static.moonpay.com/widget/currencies/miota.svg",
    network: "iota",
    decimal: 18,
    min_amount: 20,
    max_amount: 2000,
  ...
  },
  {
    ...
    icon: "https://static.moonpay.com/widget/currencies/injective-inj-logo.svg",
    network: "injective",
    decimal: 18,
    min_amount: 1.33662,
    max_amount: 250,
  ...
  },
  {
    code: "ICP_ICP",
    name: "Internet Computer ",
    icon: "https://static.moonpay.com/widget/currencies/icp_icp.svg",
    network: "icp",
    decimal: 8,
    min_amount: null,
    max_amount: null,
  ...
  },
  {
    code: "JASMY_ETH",
    name: "JasmyCoin",
    icon: "https://static.moonpay.com/widget/currencies/jasmy_eth.png",
    network: "ethereum",
    decimal: 18,
    min_amount: null,
    max_amount: null,
  ...
  },
  {
    code: "JTO_SOL",
    name: "Jito (Solana)",
    icon: "https://static.moonpay.com/widget/currencies/jto_sol.svg",
    network: "solana",
    decimal: 9,
    min_amount: null,
    max_amount: null,
  ...
  },
  {
    code: "JUP_SOL",
    name: "Jupiter (Solana)",
    icon: "https://static.moonpay.com/widget/currencies/jup_sol.svg",
    network: "solana",
    decimal: 0,
    min_amount: null,
    max_amount: null,
  ...
  {
    code: "LDO_ETH",
    name: "Lido DAO (ERC-20)",
    icon: "https://static.moonpay.com/widget/currencies/ldo_eth.svg",
    network: "ethereum",
    decimal: 12,
    min_amount: null,
    max_amount: null,
  ...
  },
  {
    ...
    icon: "https://static.moonpay.com/widget/currencies/steth-steth-logo.svg",
    network: "ethereum",
    decimal: 18,
    min_amount: null,
    max_amount: null,
  ...
  },
  {
    code: "LSK",
    name: "Lisk",
    icon: "https://static.moonpay.com/widget/currencies/lsk.png",
    network: "lisk",
    decimal: 8,
    min_amount: 34.92433,
    max_amount: null,
  ...
  {
    code: "LPT_ETH",
    name: "Livepeer (ERC-20)",
    icon: "https://static.moonpay.com/widget/currencies/lpt_eth.png",
    network: "ethereum",
    decimal: 18,
    min_amount: null,
    max_amount: null,
  ...
  },
  {
    code: "LOOKS",
    name: "LooksRare",
    icon: "https://static.moonpay.com/widget/currencies/looks.svg",
    network: "ethereum",
    decimal: 18,
    min_amount: 506.75676,
    max_amount: null,
    provider: "moonpay",
  },
  {
    code: "OM",
    name: "MANTRA DAO",
    icon: "https://static.moonpay.com/widget/currencies/om.svg",
    network: "ethereum",
    decimal: 18,
    min_amount: 1223.49103,
    max_amount: null,
    provider: "moonpay",
  },
  {
    code: "MAGIC_ARBITRUM",
    name: "Magic (Arbitrum)",
    icon: "https://static.moonpay.com/widget/currencies/magic_arbitrum.png",
    network: "arbitrum",
    decimal: 18,
    min_amount: 37.07824,
    max_amount: null,
  ...
  },
  {
    ...
    icon: "https://static.moonpay.com/widget/currencies/me_sol.jpg",
    network: "solana",
    decimal: 9,
    min_amount: null,
    max_amount: null,
  ...
  },
  {
    code: "MKR",
    name: "Maker",
    icon: "https://static.moonpay.com/widget/currencies/mkr.svg",
    network: "ethereum",
    decimal: 18,
    min_amount: 212,
    max_amount: 2000,
  ...
  },
  {
    code: "MNT_ETH",
    name: "Mantle",
    icon: "https://static.moonpay.com/widget/currencies/mnt_eth.svg",
    network: "ethereum",
    decimal: 18,
    min_amount: null,
    max_amount: null,
  ...
  },
  {
    code: "MELANIA_SOL",
    name: "Melania (Solana)",
    icon: "https://static.moonpay.com/widget/currencies/melania_sol.jpeg",
    network: "solana",
    decimal: 9,
    min_amount: null,
    max_amount: null,
  ...
  {
    code: "MEME_ETH",
    name: "Memecoin (ERC-20)",
    icon: "https://static.moonpay.com/widget/currencies/meme_eth.png",
    network: "ethereum",
    decimal: 18,
    min_amount: null,
    max_amount: null,
  ...
  },
  {
    code: "MINA_MINA",
    name: "Mina",
    icon: "https://static.moonpay.com/widget/currencies/mina_mina.svg",
    network: "mina",
    decimal: 9,
    min_amount: null,
    max_amount: null,
  ...
  {
    code: "MOG_ETH",
    name: "Mog Coin (ERC-20)",
    icon: "https://static.moonpay.com/widget/currencies/mog_eth.jpeg",
    network: "ethereum",
    decimal: 18,
    min_amount: null,
    max_amount: null,
  ...
  },
  {
    ...
    icon: "https://static.moonpay.com/widget/currencies/moodeng_sol.jpg",
    network: "solana",
    decimal: 6,
    min_amount: null,
    max_amount: null,
  ...
  },
  {
    code: "XNO",
    name: "Nano",
    icon: "https://static.moonpay.com/widget/currencies/xno.svg",
    network: "nano",
    decimal: 30,
    min_amount: 42.37288,
    max_amount: null,
  ...
  },
  {
    code: "NEIRO_ETH",
    name: "Neiro (ERC-20)",
    icon: "https://static.moonpay.com/widget/currencies/neiro_eth.png",
    network: "ethereum",
    decimal: 9,
    min_amount: null,
    max_amount: null,
  ...
  },
  {
    code: "NIM",
    name: "Nimiq",
    icon: "https://static.moonpay.com/widget/currencies/nim.svg",
    network: "nimiq",
    decimal: 5,
    min_amount: 31136.48158,
    max_amount: null,
    provider: "moonpay",
  },
  {
    code: "NOT_TON",
    name: "Notcoin",
    icon: "https://static.moonpay.com/widget/currencies/not_ton.png",
    network: "ton",
    decimal: 9,
    min_amount: null,
    max_amount: null,
  ...
  },
  {
    code: "OKB",
    name: "OKB",
    icon: "https://static.moonpay.com/widget/currencies/okb.svg",
    network: "ethereum",
    decimal: 18,
    min_amount: 212,
    max_amount: 2000,
  ...
  },
  {
    code: "OKT",
    name: "OKT",
    icon: "https://static.moonpay.com/widget/currencies/okt.png",
    network: "okc",
    decimal: 18,
    min_amount: 2.00669,
    max_amount: null,
  ...
  },
  {
    code: "ONDO_ETH",
    name: "Ondo (ERC-20)",
    icon: "https://static.moonpay.com/widget/currencies/ondo_eth.svg",
    network: "ethereum",
    decimal: 18,
    min_amount: null,
    max_amount: null,
  ...
  },
  {
    ...
    icon: "https://static.moonpay.com/widget/currencies/osmosis-osmo-logo.svg",
    network: "osmosis",
    decimal: 8,
    min_amount: null,
    max_amount: null,
  ...
  },
  {
    code: "PORTAL",
    name: "PORTAL",
    icon: "https://static.moonpay.com/widget/currencies/portal.jpg",
    network: "ethereum",
    decimal: 18,
    min_amount: null,
    max_amount: null,
  ...
  },
  {
    ...
    icon: "https://static.moonpay.com/widget/currencies/pyusd_sol.svg",
    network: "solana",
    decimal: 6,
    min_amount: null,
    max_amount: null,
  ...
  },
  {
    code: "PNUT_SOL",
    name: "Peanut the Squirrel",
    icon: "https://static.moonpay.com/widget/currencies/pnut_sol.jpg",
    network: "solana",
    decimal: 6,
    min_amount: null,
    max_amount: null,
  ...
  },
  {
    code: "PENGU_SOL",
    name: "Pengu (Solana)",
    icon: "https://static.moonpay.com/widget/currencies/pengu_sol.jpeg",
    network: "solana",
    decimal: 6,
    min_amount: null,
    max_amount: null,
  ...
  },
  {
    code: "PIXEL",
    name: "Pixels",
    icon: "https://static.moonpay.com/widget/currencies/pixel.png",
    network: "ethereum",
    decimal: 18,
    min_amount: null,
    max_amount: null,
  ...
  },
  {
    code: "PIXEL_RON",
    name: "Pixels (Ronin)",
    icon: "https://static.moonpay.com/widget/currencies/pixel_ron.png",
    network: "ronin",
    decimal: 18,
    min_amount: null,
    max_amount: null,
  ...
  },
  {
    code: "DOT",
    name: "Polkadot",
    icon: "https://static.moonpay.com/widget/currencies/dot.svg",
    network: "polkadot",
    decimal: 10,
    min_amount: 5.54119,
    max_amount: null,
  ...
  },
  {
    code: "PONKE_SOL",
    name: "Ponke",
    icon: "https://static.moonpay.com/widget/currencies/ponke_sol.svg",
    network: "solana",
    decimal: 9,
    min_amount: null,
    max_amount: null,
  ...
  },
  {
    code: "PYTH",
    name: "Pyth Network",
    icon: "https://static.moonpay.com/widget/currencies/pyth-network-pyth-logo.svg",
    network: "solana",
    decimal: 6,
    min_amount: null,
    max_amount: null,
  ...
  },
  {
    code: "QTUM",
    name: "Qtum",
    icon: "https://static.moonpay.com/widget/currencies/qtum.svg",
    network: "qtum",
    decimal: 18,
    min_amount: 20,
    max_amount: 2000,
  ...
  },
  {
    code: "QNT_ETH",
    name: "Quant (ERC-20)",
    icon: "https://static.moonpay.com/widget/currencies/qnt_eth.svg",
    network: "ethereum",
    decimal: 18,
    min_amount: null,
    max_amount: null,
  ...
  },
  {
    code: "RVN",
    name: "Ravencoin",
    icon: "https://static.moonpay.com/widget/currencies/rvn.svg",
    network: "ravencoin",
    decimal: 8,
    min_amount: 20,
    max_amount: 2000,
  ...
  },
  {
    code: "RAY_SOL",
    name: "Raydium (Solana)",
    icon: "https://static.moonpay.com/widget/currencies/ray_sol.svg",
    network: "solana",
    decimal: 6,
    min_amount: null,
    max_amount: null,
  ...
  },
  {
    code: "RENDER_SOL",
    name: "Render (Solana)",
    icon: "https://static.moonpay.com/widget/currencies/render_sol.svg",
    network: "solana",
    decimal: 8,
    min_amount: null,
    max_amount: null,
  ...
  },
  {
    code: "RONIN",
    name: "Ronin",
    icon: "https://static.moonpay.com/widget/currencies/ronin.svg",
    network: "ronin",
    decimal: 18,
    min_amount: 42.43281,
    max_amount: null,
  ...
  },
  {
    code: "SFP_BSC",
    name: "SafePal (BEP-20)",
    icon: "https://static.moonpay.com/widget/currencies/sfp_bsc.svg",
    network: "binance_smart_chain",
    decimal: 18,
    min_amount: null,
    max_amount: null,
  ...
  },
  {
    code: "SEI_SEI",
    name: "Sei (sei)",
    icon: "https://static.moonpay.com/widget/currencies/sei-sei-logo.svg",
    network: "sei",
    decimal: 18,
    min_amount: null,
    max_amount: 0,
  ...
  },
  {
    ...
    icon: "https://static.moonpay.com/widget/currencies/slp.svg",
    network: "ethereum",
    decimal: 0,
    min_amount: 17751.47929,
    max_amount: null,
    provider: "moonpay",
  },
  {
  ...
  },
  {
    code: "STX",
    name: "Stacks",
    icon: "https://static.moonpay.com/widget/currencies/stx.svg",
    network: "stacks",
    decimal: 6,
    min_amount: 47.19207,
    max_amount: null,
  ...
  },
  {
    code: "STRK_STRK",
    name: "Starknet",
    icon: "https://static.moonpay.com/widget/currencies/strk_strk.svg",
    network: "starknet",
    decimal: 18,
    min_amount: null,
    max_amount: null,
  ...
  {
    code: "STRK_ETH",
    name: "Starknet (ERC-20)",
    icon: "https://static.moonpay.com/widget/currencies/strk_eth.svg",
    network: "ethereum",
    decimal: 18,
    min_amount: null,
    max_amount: null,
  ...
  },
  {
    code: "STMX",
    name: "StormX",
    icon: "https://static.moonpay.com/widget/currencies/stmx.svg",
    network: "ethereum",
    decimal: 18,
    min_amount: 212,
    max_amount: 2000,
  ...
  },
  {
    code: "SUI",
    name: "Sui",
    icon: "https://static.moonpay.com/widget/currencies/sui.svg",
    network: "sui",
    decimal: 18,
    min_amount: 42.04036,
    max_amount: null,
  ...
  },
  {
    code: "SWARMS_SOL",
    name: "Swarms (Solana)",
    icon: "https://static.moonpay.com/widget/currencies/swarms_sol.jpg",
    network: "solana",
    decimal: 9,
    min_amount: null,
    max_amount: null,
  ...
  },
  {
    code: "SWEAT_NEAR",
    name: "Sweat (Near)",
    icon: "https://static.moonpay.com/widget/currencies/sweat_near.png",
    network: "near",
    decimal: 18,
    min_amount: 4859.87364,
    max_amount: null,
    provider: "moonpay",
  },
  {
    code: "SNX",
    name: "Synthetix",
    icon: "https://static.moonpay.com/widget/currencies/snx.svg",
    network: "ethereum",
    decimal: 18,
    min_amount: 9.70874,
    max_amount: 3500,
  ...
  },
  {
    code: "RUNE",
    name: "THORChain",
    icon: "https://static.moonpay.com/widget/currencies/rune.svg",
    network: "rune",
    decimal: 18,
    min_amount: 29.46955,
    max_amount: null,
  ...
  },
  {
    code: "TRX",
    name: "TRON",
    icon: "https://static.moonpay.com/widget/currencies/trx.svg",
    network: "tron",
    decimal: 6,
    min_amount: 84.5484,
    max_amount: 100000,
  ...
  },
  {
    code: "TRB_ETH",
    name: "Tellor (ERC-20)",
    icon: "https://static.moonpay.com/widget/currencies/trb_eth.svg",
    network: "ethereum",
    decimal: 18,
    min_amount: null,
    max_amount: null,
  ...
  },
  {
    code: "USDT_CELO",
    name: "Tether (Celo)",
    icon: "https://static.moonpay.com/widget/currencies/usdt_celo.png",
    network: "celo",
    decimal: 6,
    min_amount: null,
    max_amount: null,
  ...
  {
    code: "USDT_OPTIMISM",
    name: "Tether (OP Mainnet)",
    icon: "https://static.moonpay.com/widget/currencies/usdt_optimism.png",
    network: "optimism",
    decimal: 6,
    min_amount: null,
    max_amount: null,
  ...
  },
  {
    ...
    icon: "https://static.moonpay.com/widget/currencies/grt_polygon.svg",
    network: "polygon",
    decimal: 18,
    min_amount: null,
    max_amount: null,
  ...
  },
  {
    ...
    icon: "https://static.moonpay.com/widget/currencies/sand.svg",
    network: "ethereum",
    decimal: 18,
    min_amount: 66.0066,
    max_amount: null,
  ...
  },
  {
    ...
    icon: "https://static.moonpay.com/widget/currencies/sand_polygon.svg",
    network: "polygon",
    decimal: 18,
    min_amount: 66.0066,
    max_amount: null,
  ...
  },
  {
    code: "THETA_THETA",
    name: "Theta Network",
    icon: "https://static.moonpay.com/widget/currencies/theta_theta.svg",
    network: "theta",
    decimal: 6,
    min_amount: null,
    max_amount: null,
  ...
  },
  {
    code: "TUSD",
    name: "TrueUSD",
    icon: "https://static.moonpay.com/widget/currencies/tusd.svg",
    network: "ethereum",
    decimal: 18,
    min_amount: 212,
    max_amount: 2000,
  ...
  },
  {
    code: "USDC_BSC",
    name: "USD Coin (BSC)",
    icon: "https://static.moonpay.com/widget/currencies/usdc_bsc.svg",
    network: "binance_smart_chain",
    decimal: 18,
    min_amount: null,
    max_amount: null,
  ...
  },
  {
    code: "USDC_CELO",
    name: "USD Coin (Celo)",
    icon: "https://static.moonpay.com/widget/currencies/usd-coin-usdc-logo.svg",
    network: "celo",
    decimal: 8,
    min_amount: null,
    max_amount: null,
  ...
  },
  {
    code: "UTK",
    name: "Utrust",
    icon: "https://static.moonpay.com/widget/currencies/utk.svg",
    network: "ethereum",
    decimal: 18,
    min_amount: 437.31778,
    max_amount: null,
    provider: "moonpay",
  },
  {
    code: "VET",
    name: "VeChain",
    icon: "https://static.moonpay.com/widget/currencies/vet.svg",
    network: "vechain",
    decimal: 18,
    min_amount: 20,
    max_amount: 2000,
  ...
  },
  {
    code: "VENOM_VENOM",
    name: "Venom (Venom)",
    icon: "https://static.moonpay.com/widget/currencies/venom_venom.svg",
    network: "venom",
    decimal: 9,
    min_amount: null,
    max_amount: null,
  ...
  },
  {
    code: "VERSE",
    name: "Verse (ERC-20)",
    icon: "https://static.moonpay.com/widget/currencies/verse.png",
    network: "ethereum",
    decimal: 18,
    min_amount: 79470.19868,
    max_amount: null,
    provider: "moonpay",
  },
  {
    code: "VINE_SOL",
    name: "Vine Coin (Solana)",
    icon: "https://static.moonpay.com/widget/currencies/vine_sol.png",
    network: "solana",
    decimal: 9,
    min_amount: null,
    max_amount: null,
  ...
  },
  {
    ...
    icon: "https://static.moonpay.com/widget/currencies/virtual_base.png",
    network: "base",
    decimal: 16,
    min_amount: null,
    max_amount: null,
  ...
  },
  {
    code: "VOXEL_POLYGON",
    name: "Voxies (Polygon)",
    icon: "https://static.moonpay.com/widget/currencies/voxel_polygon.svg",
    network: "polygon",
    decimal: 18,
    min_amount: 211.26761,
    max_amount: null,
    provider: "moonpay",
  },
  {
    code: "WAXP",
    name: "WAX",
    icon: "https://static.moonpay.com/widget/currencies/waxp.svg",
    network: "wax",
    decimal: 8,
    min_amount: 20,
    max_amount: 2000,
  ...
  },
  {
    code: "WLD",
    name: "Worldcoin",
    icon: "https://static.moonpay.com/widget/currencies/wld.svg",
    network: "ethereum",
    decimal: 18,
    min_amount: 10,
    max_amount: 9999999,
  ...
  {
    code: "WLD_WLD",
    name: "Worldcoin (Worldchain)",
    icon: "https://static.moonpay.com/widget/currencies/wld_wld.svg",
    network: "worldchain",
    decimal: 18,
    min_amount: 14.6164,
    max_amount: 5000,
  ...
  },
  {
    code: "WBTC",
    name: "Wrapped Bitcoin",
    icon: "https://static.moonpay.com/widget/currencies/wbtc.svg",
    network: "ethereum",
    decimal: 8,
    min_amount: 0.0015,
    max_amount: 0.6,
  ...
  },
  {
    ...
    icon: "https://static.moonpay.com/widget/currencies/weth.svg",
    network: "ethereum",
    decimal: 18,
    min_amount: 0.01,
    max_amount: 8.5,
  ...
  },
  {
    code: "ZEC",
    name: "Zcash (deleted)",
    icon: "https://static.moonpay.com/widget/currencies/zec.svg",
    network: "zcash",
    decimal: 8,
    min_amount: 20,
    max_amount: 2000,
  ...
  },
  {
    code: "ZEREBRO_SOL",
    name: "Zerebro (Solana)",
    icon: "https://static.moonpay.com/widget/currencies/zerebro_sol.png",
    network: "solana",
    decimal: 9,
    min_amount: null,
    max_amount: null,
  ...
  },
  {
    code: "ZIL",
    name: "Zilliqa",
    icon: "https://static.moonpay.com/widget/currencies/zil.svg",
    network: "zilliqa",
    decimal: 12,
    min_amount: 20,
    max_amount: 2000,
  ...
  {
    code: "AIXBT_BASE",
    name: "aixbt by Virtuals (Base)",
    icon: "https://static.moonpay.com/widget/currencies/aixbt_base.png",
    network: "base",
    decimal: 18,
    min_amount: null,
    max_amount: null,
  ...
  {
    code: "MEW_SOL",
    name: "cat in a dogs world (Solana)",
    icon: "https://static.moonpay.com/widget/currencies/mew_sol.svg",
    network: "solana",
    decimal: 5,
    min_amount: null,
    max_amount: null,
  ...
  },
  {
    code: "DYDX_DYDX",
    name: "dYdX",
    icon: "https://static.moonpay.com/widget/currencies/dydx_dydx.svg",
    network: "dydx",
    decimal: 18,
    min_amount: null,
    max_amount: null,
  ...
  {
    code: "WIF_SOL",
    name: "dogwifhat (Solana)",
    icon: "https://static.moonpay.com/widget/currencies/wif_sol.png",
    network: "solana",
    decimal: 6,
    min_amount: null,
    max_amount: null,
