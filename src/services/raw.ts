...
export const allQuotes: QuotesResponse = [
  {
    ...
    link: "https://global-stg.transak.com?apiKey=20d3fbfb-60ed-4775-9b21-3bed7fa4b5c3&fiatCurrency=USD&cryptoCurrency=BTC&network=mainnet&isBuyOrSell=BUY&paymentMethod=credit_debit_card&fiatAmount=300",
    quote_amount: 0.00268279,
  },
  {
    provider: {
      name: "Moonpay",
    ...
    amount_to_receive: 0.00296,
    exchange_rate: 101450.34,
    payment_methods: [
      {
        id: "credit_debit_card",
        name: "Card Payment",
