export const fiatCurrenciesResponse = [
  {
    symbol: "EUR",
    supportingCountries: [
      "AT",
  ...
  },
  {
    ...
    paymentOptions: [
      ...
      },
      {
        ...
        defaultAmount: 250,
        isConverted: true,
        visaPayoutCountries: ["PR", "GB", "VI", "GU"],
    ...
    paymentOptions: [
      {
        ...
        isConverted: true,
        isPayOutAllowed: false,
        minAmountForPayOut: 864,
        maxAmountForPayOut: 2160909,
        defaultAmountForPayOut: 43200,
      },
      {
        name: "UPI",
        id: "inr_upi",
    ...
    paymentOptions: [
      {
        ...
        isPayOutAllowed: true,
        minAmountForPayOut: 110,
        maxAmountForPayOut: 274628,
        defaultAmountForPayOut: 5500,
      },
      {
        name: "Apple Pay",
        id: "apple_pay",
    ...
    paymentOptions: [
      {
        ...
        maxAmountForPayOut: 100909,
        defaultAmountForPayOut: 2000,
      },
      {
        name: "Apple Pay",
        id: "apple_pay",
    ...
    paymentOptions: [
      {
        ...
        defaultAmount: 3400,
        isConverted: true,
        visaPayoutCountries: ["NO", "SJ"],
        mastercardPayoutCountries: [],
        isPayOutAllowed: true,
        minAmountForPayOut: 113,
        maxAmountForPayOut: 282320,
        defaultAmountForPayOut: 5650,
      },
      {
        name: "Apple Pay",
        id: "apple_pay",
    ...
    paymentOptions: [
      {
        ...
        defaultAmount: 2150,
        isConverted: true,
        visaPayoutCountries: ["GL", "DK", "FO"],
        mastercardPayoutCountries: ["DK"],
        isPayOutAllowed: true,
        minAmountForPayOut: 71,
        maxAmountForPayOut: 178596,
        defaultAmountForPayOut: 3550,
      },
      {
        name: "Apple Pay",
        id: "apple_pay",
    ...
    paymentOptions: [
      {
        ...
        defaultAmount: 550,
        isConverted: true,
        visaPayoutCountries: ["NZ", "CK"],
        mastercardPayoutCountries: [],
        isPayOutAllowed: true,
        minAmountForPayOut: 18,
        maxAmountForPayOut: 44110,
    ...
    paymentOptions: [
      {
        ...
        mastercardPayoutCountries: [],
        isPayOutAllowed: true,
        minAmountForPayOut: 207,
        maxAmountForPayOut: 518143,
        defaultAmountForPayOut: 10350,
      },
      {
        name: "AstroPay",
        id: "pm_astropay",
    ...
    paymentOptions: [
      {
        ...
        defaultAmount: 500,
        isConverted: true,
        visaPayoutCountries: ["AU", "KI"],
        mastercardPayoutCountries: [],
        isPayOutAllowed: true,
        minAmountForPayOut: 16,
        maxAmountForPayOut: 39923,
    ...
    paymentOptions: [
      {
        ...
        minAmount: 5249,
        displayMessage: "",
        defaultAmount: 314950,
        isConverted: true,
        visaPayoutCountries: ["AR"],
        mastercardPayoutCountries: [],
        isPayOutAllowed: true,
        minAmountForPayOut: 10498,
        maxAmountForPayOut: 26245230,
        defaultAmountForPayOut: 524900,
      },
      {
        name: "AstroPay",
        id: "pm_astropay",
    ...
    paymentOptions: [
      {
        ...
        isConverted: true,
        isPayOutAllowed: false,
        minAmountForPayOut: 59,
        maxAmountForPayOut: 147397,
        defaultAmountForPayOut: 2950,
      },
      {
        name: "Card Payment",
        id: "credit_debit_card",
    ...
    paymentOptions: [
      {
        ...
        isConverted: true,
        isPayOutAllowed: false,
        minAmountForPayOut: 9874,
        maxAmountForPayOut: 24683750,
        defaultAmountForPayOut: 493700,
      },
      {
        name: "Apple Pay",
        id: "apple_pay",
    ...
    paymentOptions: [
      {
        ...
        provider: "checkout",
        minAmount: 2527,
        defaultAmount: 151650,
        isConverted: true,
        visaPayoutCountries: ["CR"],
        mastercardPayoutCountries: [],
        isPayOutAllowed: true,
        minAmountForPayOut: 5055,
        maxAmountForPayOut: 12637163,
        defaultAmountForPayOut: 252750,
      },
      {
        name: "Apple Pay",
        id: "apple_pay",
    ...
    paymentOptions: [
      {
        ...
        provider: "checkout",
        minAmount: 80989,
        defaultAmount: 4859300,
        isConverted: true,
        visaPayoutCountries: ["ID"],
        mastercardPayoutCountries: [],
        isPayOutAllowed: true,
        minAmountForPayOut: 161977,
        maxAmountForPayOut: 404942500,
        defaultAmountForPayOut: 8098850,
      },
      {
        name: "Google Pay",
        id: "google_pay",
    ...
    paymentOptions: [
      {
        ...
        mastercardPayoutCountries: [],
        isPayOutAllowed: true,
        minAmountForPayOut: 1551,
        maxAmountForPayOut: 3877421,
        defaultAmountForPayOut: 77550,
      },
      {
        name: "Apple Pay",
        id: "apple_pay",
    ...
    paymentOptions: [
      {
        ...
        provider: "checkout",
        minAmount: 39581,
        defaultAmount: 2374850,
        isConverted: true,
        visaPayoutCountries: ["PY"],
        mastercardPayoutCountries: [],
        isPayOutAllowed: true,
        minAmountForPayOut: 79162,
        maxAmountForPayOut: 197904486,
        defaultAmountForPayOut: 3958100,
      },
    ],
    isPopular: true,
    isAllowed: true,
    ...
    paymentOptions: [
      {
        ...
        isConverted: true,
        isPayOutAllowed: false,
        minAmountForPayOut: 585,
        maxAmountForPayOut: 1463375,
        defaultAmountForPayOut: 29250,
      },
      {
        name: "Maya",
        id: "pm_paymaya",
    ...
    paymentOptions: [
      {
        ...
        maxAmountForPayOut: 33746,
        defaultAmountForPayOut: 700,
      },
      {
        name: "Apple Pay",
        id: "apple_pay",
    ...
    paymentOptions: [
      {
        ...
        provider: "checkout",
        minAmount: 1956,
        defaultAmount: 117350,
        isConverted: true,
        visaPayoutCountries: ["HU"],
        mastercardPayoutCountries: ["HU"],
        isPayOutAllowed: true,
        minAmountForPayOut: 3912,
        maxAmountForPayOut: 9779137,
        defaultAmountForPayOut: 195600,
      },
      {
        name: "Apple Pay",
        id: "apple_pay",
    ...
    paymentOptions: [
      {
        ...
        mastercardPayoutCountries: [],
        isPayOutAllowed: true,
        minAmountForPayOut: 185,
        maxAmountForPayOut: 461257,
        defaultAmountForPayOut: 9250,
      },
      {
        name: "Apple Pay",
        id: "apple_pay",
    ...
    paymentOptions: [
      {
        ...
        isPayOutAllowed: true,
        minAmountForPayOut: 240,
        maxAmountForPayOut: 600716,
        defaultAmountForPayOut: 12000,
      },
      {
        name: "Apple Pay",
        id: "apple_pay",
    ...
    paymentOptions: [
      {
        ...
        isPayOutAllowed: true,
        minAmountForPayOut: 1401,
        maxAmountForPayOut: 3501750,
        defaultAmountForPayOut: 70050,
      },
      {
        name: "Apple Pay",
        id: "apple_pay",
    ...
    paymentOptions: [
      {
        ...
        isPayOutAllowed: true,
        minAmountForPayOut: 48,
        maxAmountForPayOut: 119070,
        defaultAmountForPayOut: 2400,
      },
      {
        name: "Apple Pay",
        id: "apple_pay",
    ...
    paymentOptions: [
      {
        ...
        provider: "checkout",
        minAmount: 4568,
        defaultAmount: 274100,
        isConverted: true,
        visaPayoutCountries: ["AO"],
        mastercardPayoutCountries: [],
        isPayOutAllowed: true,
        minAmountForPayOut: 9137,
        maxAmountForPayOut: 22841667,
        defaultAmountForPayOut: 456850,
      },
      {
        name: "Google Pay",
        id: "google_pay",
    ...
    paymentOptions: [
      {
        ...
        defaultAmount: 800,
        isConverted: true,
        visaPayoutCountries: ["KN", "DM", "GD", "AI", "LC", "AG", "VC"],
        mastercardPayoutCountries: [],
        isPayOutAllowed: true,
    ...
    paymentOptions: [
      {
        ...
        mastercardPayoutCountries: [],
        isPayOutAllowed: true,
        minAmountForPayOut: 29,
        maxAmountForPayOut: 71875,
        defaultAmountForPayOut: 1450,
      },
    ],
    isPopular: true,
    isAllowed: true,
    ...
    paymentOptions: [
      {
        ...
        provider: "checkout",
        minAmount: 2584,
        defaultAmount: 155000,
        isConverted: true,
        visaPayoutCountries: ["KZ"],
        mastercardPayoutCountries: [],
        isPayOutAllowed: true,
        minAmountForPayOut: 5167,
        maxAmountForPayOut: 12917543,
        defaultAmountForPayOut: 258350,
      },
      {
        name: "Apple Pay",
        id: "apple_pay",
    ...
    paymentOptions: [
      {
        ...
        provider: "checkout",
        minAmount: 23404,
        defaultAmount: 1404250,
        isConverted: true,
        visaPayoutCountries: ["MG"],
        mastercardPayoutCountries: [],
        isPayOutAllowed: true,
        minAmountForPayOut: 46809,
        maxAmountForPayOut: 117021634,
        defaultAmountForPayOut: 2340450,
      },
    ],
    isPopular: true,
    isAllowed: true,
    ...
    paymentOptions: [
      {
        ...
        provider: "checkout",
        minAmount: 8672,
        defaultAmount: 520350,
        isConverted: true,
        visaPayoutCountries: ["MW"],
        mastercardPayoutCountries: [],
        isPayOutAllowed: true,
        minAmountForPayOut: 17345,
        maxAmountForPayOut: 43361339,
        defaultAmountForPayOut: 867250,
      },
    ],
    isPopular: true,
    isAllowed: true,
    ...
    paymentOptions: [
      {
        ...
        mastercardPayoutCountries: [],
        isPayOutAllowed: true,
        minAmountForPayOut: 398,
        maxAmountForPayOut: 995761,
        defaultAmountForPayOut: 19900,
      },
    ],
    isPopular: true,
    isAllowed: true,
    ...
    paymentOptions: [
      {
        ...
        provider: "checkout",
        minAmount: 6971,
        defaultAmount: 418250,
        isConverted: true,
        visaPayoutCountries: ["RW"],
        mastercardPayoutCountries: [],
        isPayOutAllowed: true,
        minAmountForPayOut: 13942,
        maxAmountForPayOut: 34853763,
        defaultAmountForPayOut: 697100,
      },
    ],
    isPopular: true,
    isAllowed: true,
    ...
    paymentOptions: [
      {
        ...
        mastercardPayoutCountries: [],
        isPayOutAllowed: true,
        minAmountForPayOut: 351,
        maxAmountForPayOut: 877625,
        defaultAmountForPayOut: 17550,
      },
    ],
    isPopular: true,
    isAllowed: true,
    ...
    paymentOptions: [
      {
        ...
        mastercardPayoutCountries: [],
        isPayOutAllowed: true,
        minAmountForPayOut: 187,
        maxAmountForPayOut: 467708,
        defaultAmountForPayOut: 9350,
      },
    ],
    isPopular: true,
    isAllowed: true,
    ...
    paymentOptions: [
      {
        ...
        mastercardPayoutCountries: [],
        isPayOutAllowed: true,
        minAmountForPayOut: 433,
        maxAmountForPayOut: 1081691,
        defaultAmountForPayOut: 21650,
      },
      {
        name: "AstroPay",
        id: "pm_astropay",
    ...
    paymentOptions: [
      {
        ...
        mastercardPayoutCountries: [],
        isPayOutAllowed: true,
        minAmountForPayOut: 152,
        maxAmountForPayOut: 380193,
        defaultAmountForPayOut: 7600,
      },
    ],
    roundOff: 2,
    isPayOutAllowed: true,
    ...
    paymentOptions: [
      {
        ...
        provider: "checkout",
        minAmount: 20110,
        defaultAmount: 1206600,
        isConverted: true,
        visaPayoutCountries: ["KH"],
        mastercardPayoutCountries: [],
        isPayOutAllowed: true,
        minAmountForPayOut: 40221,
        maxAmountForPayOut: 100551333,
        defaultAmountForPayOut: 2011050,
      },
    ],
    roundOff: 2,
    isPayOutAllowed: true,
    ...
    paymentOptions: [
      {
        ...
        mastercardPayoutCountries: [],
        isPayOutAllowed: true,
        minAmountForPayOut: 1121,
        maxAmountForPayOut: 2802869,
        defaultAmountForPayOut: 56050,
      },
      {
        name: "Apple Pay",
        id: "apple_pay",
    ...
    paymentOptions: [
      {
        ...
        mastercardPayoutCountries: [],
        isPayOutAllowed: true,
        minAmountForPayOut: 589,
        maxAmountForPayOut: 1472827,
        defaultAmountForPayOut: 29450,
      },
    ],
    roundOff: 2,
    isPayOutAllowed: true,
    ...
    paymentOptions: [
      {
        ...
        provider: "checkout",
        minAmount: 1997,
        defaultAmount: 119800,
        isConverted: true,
        visaPayoutCountries: ["AM"],
        mastercardPayoutCountries: [],
        isPayOutAllowed: true,
        minAmountForPayOut: 3994,
        maxAmountForPayOut: 9984320,
        defaultAmountForPayOut: 199700,
      },
      {
        name: "Apple Pay",
        id: "apple_pay",
    ...
    paymentOptions: [
      {
        ...
        mastercardPayoutCountries: [],
        isPayOutAllowed: true,
        minAmountForPayOut: 1049,
        maxAmountForPayOut: 2622123,
        defaultAmountForPayOut: 52450,
      },
    ],
    roundOff: 2,
    isPayOutAllowed: true,
    ...
    paymentOptions: [
      {
        ...
        mastercardPayoutCountries: [],
        isPayOutAllowed: true,
        minAmountForPayOut: 19,
        maxAmountForPayOut: 46511,
        defaultAmountForPayOut: 950,
      },
    ],
    roundOff: 2,
    isPayOutAllowed: true,
