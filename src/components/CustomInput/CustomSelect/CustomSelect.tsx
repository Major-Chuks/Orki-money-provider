...
// Add forwardRef here 👇
const CustomSelect = forwardRef<HTMLDivElement, ExtendedInput>(
  (
    {
      label,
      placeholder,
    ...
    // 👇 Expose internal DOM ref to the forwarded ref
    ...
    return (
      <DropdownLayout portal={!!portalTo}>
        {({ open, close, toggle }) => (
          <div
            ref={containerRef} // 👈 internal ref to DOM element
          ...
          >
            ...
            <DropdownWrapper
              open={open}
              callerRef={containerRef} // 👈 Pass the ref
              containerStyle={{
                width: "100%",
                padding: "1px",
                zIndex: "99999",
